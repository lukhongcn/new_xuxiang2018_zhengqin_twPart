...
<%@ Page language="c#" Codebehind="ReqcreportdetailView.aspx.cs" AutoEventWireup="false" Inherits="ModuleWorkFlow.ReqcreportdetailView" %>
									...
									<td vAlign="top">
										<table width="100%" align="center" border="0">
											...
											<tr>
												...
												<td><asp:label id="lab_PartnoOuter" runat="server" Text="外觀"></asp:label></td>
											...
											<tr>
												...
												<td><asp:label id="lab_StandardSize" runat="server" Text="標值"></asp:label></td>
												<td><asp:textbox id="txt_StandardSize" runat="server" AutoPostBack="True"></asp:textbox></td>
											</tr>
											<tr>
												<td><asp:label id="lab_Difference" runat="server" Text="公差"></asp:label></td>
												...
												<td><asp:label id="lab_Partcount" runat="server" Text="件數"></asp:label></td>
												<td><asp:textbox id="txt_Partcount" runat="server"></asp:textbox></td>
											</tr>
											<tr>
												<td><asp:label id="lab_JudgeId" runat="server" Text="判定"></asp:label></td>
												...
												<TD colSpan="2"><asp:label id="funcdetail" runat="server" Text="" Visible="False"></asp:label><asp:button id="btn_add_detailedit" runat="server" Text="保存"></asp:button></TD>
											</tr>
											<tr>
												<td colSpan="6"><asp:datagrid id="dg_Reqcreportdetail" runat="server" CellPadding="2" CellSpacing="2" AutoGenerateColumns="False">
														...
														<Columns>
															...
															<asp:TemplateColumn HeaderText="PartnoOuter">
																<HeaderTemplate>
																	<asp:Label id="dg_header_PartnoOuter" runat="server">外觀</asp:Label>
																</HeaderTemplate>
																<ItemTemplate>
																	&nbsp;
															...
															<asp:TemplateColumn HeaderText="Partcount">
																<HeaderTemplate>
																	<asp:Label id="dg_header_Partcount" runat="server">件數</asp:Label>
																</HeaderTemplate>
																<ItemTemplate>
																	&nbsp;
															...
															<asp:TemplateColumn HeaderText="JudgeId">
																<HeaderTemplate>
																	<asp:Label id="dg_header_JudgeId" runat="server">判定</asp:Label>
																</HeaderTemplate>
																<ItemTemplate>
																	&nbsp;
