...
<%@ Page language="c#" Codebehind="xuxiangReqcreportView.aspx.cs" AutoEventWireup="false" Inherits="ModuleWorkFlow.admin.xuxiangReqcreportView" %>
    ...
    <TD vAlign=top width="79%"><uc1:reqcreportheader id=ReqcreportHeader runat="server"></uc1:reqcreportheader><br 
      ...
      cellPadding=0 width="100%" align=center borderColorLight=#ccccff border=1 
       runat="server">
        <tr>
          <td vAlign=top>
            <table width="100%" align=center border=0><asp:label id=lab_Id runat="server" Text="" Visible="False"></asp:label>
              <tr>
                ...
                <td><asp:textbox id=txt_testid Runat="server"></asp:textbox></td></tr>
              <tr>
                ...
                <td style="HEIGHT: 35px"><FONT face=新細明體 
                  ><asp:dropdownlist id=dpl_Moduleid runat="server" AutoPostBack="True"></asp:dropdownlist></FONT></td></tr>
              <tr>
                <td style="WIDTH: 134px"><asp:label id=lab_partnoId runat="server" Text="零件"></asp:label></td>
                <td style="WIDTH: 283px"><FONT face=新細明體 
                  ><asp:dropdownlist id=dpl_partnoId1 runat="server" AutoPostBack="True"></asp:dropdownlist></FONT></td>
                <td style="WIDTH: 135px; HEIGHT: 19px"><asp:label id=lab_ProductMaterialInventoryId runat="server" Text="成品料號"></asp:label></td>
                <td style="HEIGHT: 19px"><asp:textbox id=txt_ProductMaterialInventoryId runat="server" Width="300" MaxLength="50" ReadOnly="True" BackColor="Silver"></asp:textbox></td></tr>
              <tr>
                <td style="WIDTH: 134px; HEIGHT: 19px"><asp:label id=lab_Pictureno runat="server" Text="圖號"></asp:label></td>
                <td style="WIDTH: 283px; HEIGHT: 19px"><asp:textbox id=txt_Pictureno runat="server" Width="200" ReadOnly="True" BackColor="Silver"></asp:textbox></td>
                <td style="WIDTH: 135px"><asp:label id=lab_materialId runat="server" Text="材質"></asp:label></td>
                <td><asp:textbox id=txt_materialId runat="server" ReadOnly="True" BackColor="Silver"></asp:textbox><asp:dropdownlist id=dpl_materialId runat="server" Visible="False" AutoPostBack="True"></asp:dropdownlist><asp:button id=btn_materialId runat="server" Text="選擇" Visible="False"></asp:button></td></tr>
              <TR>
                ...
                <TD colSpan=2><asp:label id=func runat="server" Text="" Visible="False"></asp:label><asp:button id=btn_add_edit runat="server" Text="保存"></asp:button></TD></TR></table>
            ...
            runat="server">
              <tr>
                <td vAlign=top>
                  <table width="100%" align=center border=0><asp:label id=lab_Iddetail runat="server" Text="" Visible="False"></asp:label><asp:label id=lab_QcreportId runat="server" Text="" Visible="False"></asp:label><asp:label id=lab_partnoId1 runat="server" Text="" Visible="False"></asp:label>
                    <tr>
                      ...
                      <td><asp:label id=lab_Machineid runat="server" Text="機台編號" Visible="False"></asp:label></td>
                      <td><asp:dropdownlist id=dpl_Machineid runat="server" Visible="False"></asp:dropdownlist></td></tr>
                    <tr>
                      ...
                      <td><asp:dropdownlist id=dpl_JudgeId runat="server"></asp:dropdownlist></td></tr>
                    <tr>
                      ...
                      <td><asp:textbox id=txt_Checker runat="server"></asp:textbox><asp:dropdownlist id=dpl_Checker runat="server" AutoPostBack="True"></asp:dropdownlist></td></tr>
                    <tr>
                      ...
                      <td><asp:dropdownlist id=dpl_CheckMachineNo runat="server"></asp:dropdownlist></td></tr>
                    <tr>
                      <td><asp:label id=lab_Partcount runat="server" Text="零件件數"></asp:label></td>
                      <td><asp:textbox id=txt_Partcount runat="server" ReadOnly="True" BackColor="Silver"></asp:textbox></td>
                      <td><asp:label id=lab_CheckNumber runat="server" Text="檢測數量"></asp:label></td>
                      <td><asp:textbox id=txt_CheckNumber runat="server">0</asp:textbox></td></tr>
                    <tr>
                      ...
                      <td><asp:textbox id=txt_PartnoOuter runat="server"></asp:textbox></td></tr>
                    <tr>
                      <td><asp:label id=lab_Difference runat="server" Text="公差" Visible="False"></asp:label></td>
                      <td><asp:textbox id=txt_Difference runat="server" Visible="False"></asp:textbox></td>
                      <td><asp:label id=lab_StandardSize runat="server" Text="標值" Visible="False"></asp:label></td>
                      <td><asp:textbox id=txt_StandardSize runat="server" Visible="False"></asp:textbox></td></tr>
                    <tr>
                      <TD colSpan=2><asp:label id=funcdetail runat="server" Text="" Visible="False"></asp:label><asp:button id=btn_add_detailedit runat="server" Text="保存"></asp:button></TD></tr>
                    <tr>
                      <td colSpan=6><asp:datagrid id=dg_Reqcreportdetail runat="server" CellPadding="2" CellSpacing="2" AutoGenerateColumns="False" AllowPaging="True">
