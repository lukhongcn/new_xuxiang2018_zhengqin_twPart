<%@ Page language="c#" Codebehind="ReqcreportList.aspx.cs" AutoEventWireup="false" Inherits="ModuleWorkFlow.ReqcreportList" %>
...
<asp:Label id=lab_Id Visible="False" Runat="server" text=""></asp:Label></TD>
											</TR>
											<tr>
												<td colSpan="2">
													<asp:datagrid id="dg_Reqcreport" runat="server" AutoGenerateColumns="False" CellSpacing="2" CellPadding="2"
														AllowPaging="True">
														...
														<Columns>
															...
															<asp:TemplateColumn HeaderText="Ver">
																...
																<EditItemTemplate>
																	<asp:textbox id="dg_txt_Ver" Width="40" runat="server" Text='<%#DataBinder.Eval(Container, "DataItem.Ver") %>'/>
																</EditItemTemplate>
															</asp:TemplateColumn>
															<asp:EditCommandColumn ButtonType="LinkButton" UpdateText="更新" CancelText="" EditText="QC明細"></asp:EditCommandColumn>
															<asp:TemplateColumn>
																<ItemTemplate>
																	<asp:HyperLink id=HyperLink_Edit runat="server" Text="編輯" NavigateUrl='<%# "ReqcreportView.aspx?func=edit&id="+DataBinder.Eval(Container, "DataItem.Id") %>'>
																	</asp:HyperLink>
																</ItemTemplate>
															</asp:TemplateColumn>
