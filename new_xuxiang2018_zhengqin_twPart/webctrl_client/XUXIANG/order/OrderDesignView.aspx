				...
				<TABLE id="Table2" cellSpacing="0" cellPadding="0" width="100%" border="0">
					<TBODY>
						...
						<TR>
							...
							<TD width="1%">&nbsp;</TD>
							<TD vAlign="top" width="79%"><uc1:orderdesignheader id="OrderHeader" runat="server"></uc1:orderdesignheader><BR>
								<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="1">
									<TBODY>
										...
										<tr>
											<td>工令單號</td>
											<td><asp:textbox ID="txt_ordersingle" Runat="server"></asp:textbox></td>
										...
										<tr>
											...
											<td><FONT face="新細明體">
													<asp:label id="lab_tryDate2" runat="server" Text="TryDate2">T2</asp:label></FONT></td>
											<td><wc:inputcalendar id="txt_tryDate2" runat="server"></wc:inputcalendar></td>
										</tr>
										<tr>
											<td>T3</td>
											<td>
												<wc:inputcalendar id="txt_T3" runat="server"></wc:inputcalendar></td>
											<td><FONT face="新細明體">
