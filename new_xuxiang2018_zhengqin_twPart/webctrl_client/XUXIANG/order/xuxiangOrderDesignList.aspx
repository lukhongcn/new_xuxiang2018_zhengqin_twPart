...
<%@ Page language="c#" Codebehind="xuxiangOrderDesignList.aspx.cs" AutoEventWireup="false" Inherits="ModuleWorkFlow.xuxiangOrderDesignList" %>
			...
			<TABLE id="Table2" cellSpacing="0" cellPadding="0" width="100%" border="0">
				<TBODY>
					...
					<TR>
						...
						<TD width="1%">&nbsp;</TD>
						<TD vAlign="top" width="79%"><uc1:xuxiangorderdesignheader id="xuxiangOrderDesignHeader" runat="server"></uc1:xuxiangorderdesignheader>
							<table id="Table_Header2" cellSpacing="0" cellPadding="0" width="100%" border="1">
								...
								<tr>
									<td><asp:label id="lab_print" Text="打印條碼選擇" Runat="server"></asp:label><asp:textbox id="txt_print" Runat="server"></asp:textbox><asp:label id="lab_show" Text="例如:1-10" Runat="server"></asp:label></td>
									<td><asp:button id="btn_print" Text="打印條碼" Runat="server"></asp:button><asp:label id="lab_file" Runat="server"></asp:label></td>
								</tr>
								<tr>
							...
							<asp:datagrid id="MainDataGrid" runat="server" Width="100%" AutoGenerateColumns="False" AllowPaging="True"
								...
								<Columns>
									...
									<asp:TemplateColumn>
										<ItemTemplate>
											<a href='#' onclick='javascript:showXuxiangModuleInfo("<%#DataBinder.Eval(Container, "DataItem.Id") %>")'>
												詳細信息</a>
										</ItemTemplate>
									</asp:TemplateColumn>
									<asp:TemplateColumn>
										<ItemTemplate>
											<asp:HyperLink id=HyperLink_Edit runat="server" Text="編輯" NavigateUrl='<%# "xuxiangOrderDesignView.aspx?func=edit&moduleid="+DataBinder.Eval(Container, "DataItem.moduleid") %>'>
											</asp:HyperLink>
										</ItemTemplate>
									</asp:TemplateColumn>
