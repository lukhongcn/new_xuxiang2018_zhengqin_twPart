<%@ Page language="c#" Codebehind="ModuleSkillAdd.aspx.cs" AutoEventWireup="false" Inherits="ModuleWorkFlow.FileManage.ModuleSkillAdd" %>
							...
							<TD vAlign="top" width="79%"><uc1:orderheader id="OrderHeader" runat="server"></uc1:orderheader><BR>
								<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="1">
									<TBODY>
										...
										<TR>
											<TD>模具編號</TD>
											<TD align="left"><asp:dropdownlist id="Dropdownlist_Customer" runat="server" AutoPostBack="True"></asp:dropdownlist><font color="red">*</font></TD>
										</TR>
									</TBODY>
								</TABLE>
								<table>
