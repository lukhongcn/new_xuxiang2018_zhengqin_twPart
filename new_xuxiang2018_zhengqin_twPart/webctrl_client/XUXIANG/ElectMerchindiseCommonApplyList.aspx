...
<%@ Page language="c#" Codebehind="ElectMerchindiseCommonApplyList.aspx.cs" AutoEventWireup="false" Inherits="ModuleWorkFlow.ElectMerchindiseCommonApply" %>
						...
						<TD vAlign="top" width="79%">
							...
							<TABLE id="Table1" borderColor="#ccccff" cellSpacing="1" borderColorDark="#cccccc" cellPadding="0"
								...
								<tr>
									...
									<td style="WIDTH: 195px; HEIGHT: 43px"><asp:dropdownlist id="ListBox_CustomerList" runat="server" Width="157px" AutoPostBack="True"></asp:dropdownlist><asp:label id="Label1" runat="server" Visible="False"></asp:label><asp:label id="lab_ApplyNo" runat="server" Visible="False"></asp:label></td>
									<td style="HEIGHT: 43px"><asp:label id="lab_moduleId" runat="server" Text="模具編號"></asp:label></td>
									<td style="WIDTH: 171px; HEIGHT: 43px"><asp:dropdownlist id="ListBox_ModuleList" runat="server" Width="157px" AutoPostBack="True"></asp:dropdownlist></td>
								...
								<TR>
									...
									<TD style="WIDTH: 195px; HEIGHT: 30px"><asp:dropdownlist id="ListBox_mat" runat="server" Width="157px" AutoPostBack="True" Enabled="False"></asp:dropdownlist></TD>
									<td style="HEIGHT: 30px"><asp:label id="Label3" runat="server">工藝類型</asp:label></td>
									<TD style="WIDTH: 171px; HEIGHT: 30px"><asp:dropdownlist id="ListBox_process" runat="server" Width="157px" AutoPostBack="True" Enabled="False"></asp:dropdownlist></TD>
								</TR>
								<TR>
									<TD vAlign="top">申請單明細</TD>
									<td style="WIDTH: 625px" colSpan="5"><asp:textbox id="txt_content" runat="server" Width="688px" TextMode="MultiLine" Height="200px"></asp:textbox></td>
								</TR>
								<tr>
									<td><asp:button id="btn_add_edit" runat="server" Text="保存"></asp:button><asp:label id="func" runat="server" Text="" Visible="False"></asp:label></td>
							...
							<table>
								<tr>
									<td><asp:datagrid id="dg_error" runat="server" AutoGenerateColumns="False" AllowPaging="True">
											<Columns>
							...
							<table>
								...
								<tr>
									<td style="WIDTH: 578px" colSpan="2"><asp:datagrid id="dg_ElectMerchindiseApply" runat="server" AutoGenerateColumns="False" AllowPaging="True"
											...
											<Columns>
												...
												<asp:TemplateColumn HeaderText="electSpec">
													<HeaderTemplate>
														<asp:Label id="dg_header_electSpec" runat="server">規格</asp:Label>
													</HeaderTemplate>
													<ItemTemplate>
														&nbsp;
