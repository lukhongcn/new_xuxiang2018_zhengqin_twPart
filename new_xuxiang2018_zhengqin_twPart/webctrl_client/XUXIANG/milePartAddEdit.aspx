...
<%@ Page language="c#" Codebehind="milePartAddEdit.aspx.cs" AutoEventWireup="false" Inherits="ModuleWorkFlow.milePartAddEdit" %>
							...
							<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="1">
								<TBODY>
									...
									<TR>
										...
										<TD><FONT face="新細明體"><asp:textbox id="TextBox_PartCount" runat="server"></asp:textbox><asp:regularexpressionvalidator id="RegularExpressionValidator1" runat="server" ErrorMessage="請輸入數字類型" ControlToValidate="TextBox_PartCount"
