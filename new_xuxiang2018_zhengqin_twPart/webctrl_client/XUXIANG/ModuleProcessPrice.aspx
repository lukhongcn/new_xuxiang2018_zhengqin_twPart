...
<%@ Page language="c#" Codebehind="ModuleProcessPrice.aspx.cs" AutoEventWireup="false" Inherits="ModuleWorkFlow.ModuleProcessPrice" %>
...
<HTML>
	...
	<body topMargin="0">
		<form id="Form1" method="post" runat="server">
								...
								<tr>
									<td colSpan="2"><c1webgrid:c1webgrid id="dg_detail" runat="server" Width="100%" CellPadding="2" CellSpacing="2" AutoGenerateColumns="False"
											...
											<Columns>
												...
												<c1webgrid:C1TemplateColumn HeaderText="productId" visible="false">
													<HeaderTemplate>
												...
												<c1webgrid:C1BoundColumn HeaderText="工序名稱" DataField="ProcessName"></c1webgrid:C1BoundColumn>
												<c1webgrid:C1BoundColumn HeaderText="工序加工費" DataField="MachinePrice"></c1webgrid:C1BoundColumn>
												<c1webgrid:C1BoundColumn HeaderText="報廢加工費" DataField="DisCardPrice"></c1webgrid:C1BoundColumn>
												<c1webgrid:C1BoundColumn HeaderText="外包費" DataField="OutSourcePrice"></c1webgrid:C1BoundColumn>
												<c1webgrid:C1BoundColumn HeaderText="報廢材料費" DataField="discardmaterialprice"></c1webgrid:C1BoundColumn>
												<c1webgrid:C1BoundColumn HeaderText="材料費" DataField="MaterialPrice"></c1webgrid:C1BoundColumn>
												<c1webgrid:C1BoundColumn HeaderText="模具變更費" DataField="projectPrice"></c1webgrid:C1BoundColumn>
											</Columns>
											<HeaderStyle Wrap="False" HorizontalAlign="Center" VerticalAlign="Middle" BackColor="#AAAADD"></HeaderStyle>
											<SelectedItemStyle HorizontalAlign="Center"></SelectedItemStyle>
											<EditItemStyle HorizontalAlign="Center"></EditItemStyle>
										</c1webgrid:c1webgrid><asp:label id="Label1" runat="server">模具統計總費用:</asp:label><asp:label id="lab_price" runat="server"></asp:label><asp:label id="lab_ttp" runat="server" Visible="False"></asp:label></td>
								</tr>
							</TABLE>
							<asp:button id="btn_print" runat="server" Text="生成報表"></asp:button><asp:label id="lab_print1" runat="server"></asp:label></TD>
					</tr>
				</TBODY>
			</TABLE>
			<br>
			...
			<table>
				<tr>
					<td><c1webgrid:c1webgrid id="C1webgrid1" runat="server" Width="100%" CellPadding="2" CellSpacing="2" AutoGenerateColumns="False"
							PageSize="18" DefaultRowHeight="22px" DefaultColumnWidth="120px">
							<AlternatingItemStyle HorizontalAlign="Center"></AlternatingItemStyle>
							<ItemStyle HorizontalAlign="Center"></ItemStyle>
							<PagerStyle Mode="NumericPages"></PagerStyle>
							<Columns>
								...
								<c1webgrid:C1BoundColumn HeaderText="模具變更費" DataField="projectPrice"></c1webgrid:C1BoundColumn>
								<c1webgrid:C1BoundColumn HeaderText="報廢加工費" DataField="DisCardPrice"></c1webgrid:C1BoundColumn>
								<c1webgrid:C1BoundColumn HeaderText="報廢材料費" DataField="DisCardPrice"></c1webgrid:C1BoundColumn>
