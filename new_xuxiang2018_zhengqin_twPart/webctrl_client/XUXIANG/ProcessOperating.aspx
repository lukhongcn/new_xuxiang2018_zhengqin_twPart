...
<%@ Register TagPrefix="uc1" TagName="ProcessOperating" Src="controls/ProcessOperating.ascx" %>
<%@ Page language="c#" Codebehind="ProcessOperating.aspx.cs" AutoEventWireup="false" Inherits="ModuleWorkFlow.ProcessOperatiing" %>
<%@ Register TagPrefix="wc" Namespace="WebControlLibrary" Assembly="WebControlLibrary" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
  <HEAD>
		<title>實際生產時間調整</title>
			...
			<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="0">
				<TBODY>
					...
					<TR>
						...
						<TD vAlign="top" width="79%"><uc1:ProcessOperating id="ProcessOperating" runat="server"></uc1:ProcessOperating>
											...
											<div style="OVERFLOW-Y: scroll; WIDTH: 100%; BORDER-TOP-STYLE: ridge; BORDER-RIGHT-STYLE: ridge; BORDER-LEFT-STYLE: ridge; HEIGHT: 300px; BORDER-BOTTOM-STYLE: ridge"><asp:datagrid id="MainDataGrid" runat="server" AutoGenerateColumns="False" Width="100%" CellSpacing="2"
													...
													<Columns>
														...
														<asp:TemplateColumn HeaderText="狀態">
															<ItemTemplate>
																<asp:Label runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.StatusDesc") %>'>
																</asp:Label>
															</ItemTemplate>
														</asp:TemplateColumn>
														...
														<asp:BoundColumn DataField="processno" HeaderText="processno" Visible="False"></asp:BoundColumn>
													</Columns>
												</asp:datagrid></div>
											<br>
												...
												<TBODY>
													<tr>
														<td colSpan="6"><B>請填入以下信息修改紀錄</B>
															<asp:label id="Label_HiddenHoursPerDay" runat="server" ForeColor="Red" Visible="False"></asp:label>
															<asp:label id="Label_HiddenPartNo" runat="server" ForeColor="Red" Visible="False"></asp:label>
															<asp:label id="Label_HiddenProcessNo" runat="server" ForeColor="Red" Visible="False"></asp:label>
														</td>
													</tr>
													<TR>
