...
<%@ Page language="c#" Codebehind="KnifeInInventoryList.aspx.cs" AutoEventWireup="false" Inherits="ModuleWorkFlow.KnifeInInventoryList" %>
											...
											<tr>
												<td colSpan="2"><asp:datagrid id="dg_InInventory" runat="server" AllowPaging="True" CellPadding="2" CellSpacing="2"
														...
														<Columns>
															...
															<asp:TemplateColumn>
																<ItemTemplate>
																	<asp:HyperLink id=HyperLink_Edit runat="server" Text="編輯" NavigateUrl='<%# "KnifeInInventoryView.aspx?func=edit&id="+DataBinder.Eval(Container, "DataItem.Id") %>'>
																	</asp:HyperLink>
																</ItemTemplate>
															</asp:TemplateColumn>
