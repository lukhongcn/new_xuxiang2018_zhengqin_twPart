								...
								<tr>
									<td vAlign="top">
										<table width="100%" align="center" border="0">
											...
											<tr>
												<td><asp:Label ID="lab_createDate" runat="server" Text="填單日期"></asp:Label></td>
												<td><wc:inputcalendar id="txt_createDate" runat="server"></wc:inputcalendar><FONT face="宋體"></FONT></td>
											</tr>
											<tr>
												<td><asp:Label ID="lab_discardNo" runat="server" Text="報廢單號"></asp:Label></td>
												<td><asp:textbox id="txt_discardNo" runat="server" ReadOnly="True"></asp:textbox></td>
											</tr>
											<tr>
												<td><asp:Label ID="lab_productMaterialNo" runat="server" Text="報廢刀具編號"></asp:Label></td>
												<td><asp:textbox id="txt_productMaterialNo" runat="server"></asp:textbox></td>
											</tr>
											<tr>
												<td><asp:Label ID="lab_discardCount" runat="server" Text="數量"></asp:Label></td>
											...
											<tr>
												<td><asp:Label ID="lab_discarder" runat="server" Text="報廢人"></asp:Label></td>
												<td>
													...
													<asp:datagrid id="dg_KnifeDiscard" runat="server" AutoGenerateColumns="False" CellSpacing="2"
														...
														<Columns>
															<asp:TemplateColumn HeaderText="createDate">
																<HeaderTemplate>
																	<asp:Label id="dg_header_createDate" runat="server">填單日期</asp:Label>
																</HeaderTemplate>
																<ItemTemplate>
																	&nbsp;
															...
															<asp:TemplateColumn HeaderText="discardNo">
																<HeaderTemplate>
																	<asp:Label id="dg_header_discardNo" runat="server">報廢單號</asp:Label>
																</HeaderTemplate>
																<ItemTemplate>
																	&nbsp;
															...
															<asp:TemplateColumn HeaderText="productMaterialId">
																<HeaderTemplate>
																	<asp:Label id="dg_header_productMaterialId" runat="server">報廢刀具編號</asp:Label>
																</HeaderTemplate>
																<ItemTemplate>
																	&nbsp;
															...
															<asp:TemplateColumn HeaderText="discardCount">
																<HeaderTemplate>
																	<asp:Label id="dg_header_discardCount" runat="server">數量</asp:Label>
																</HeaderTemplate>
																<ItemTemplate>
																	&nbsp;
															...
															<asp:TemplateColumn HeaderText="discarder">
																<HeaderTemplate>
																	<asp:Label id="dg_header_discarder" runat="server">報廢人</asp:Label>
																</HeaderTemplate>
																<ItemTemplate>
																	&nbsp;
															...
															<asp:EditCommandColumn ButtonType="LinkButton" UpdateText="編輯" HeaderText="編輯" CancelText="??" EditText="編輯"></asp:EditCommandColumn>
