...
<%@ Page language="c#" Codebehind="ScheduleListBig.aspx.cs" AutoEventWireup="false" Inherits="ModuleWorkFlow.ScheduleListBig" %>
<%@ Register TagPrefix="uc1" TagName="ScheduleListBigHeader" Src="controls/ScheduleListBigHeader.ascx" %>
				...
				<TBODY>
					...
					<TR>
						...
						<TD vAlign="top" width="79%">
							<uc1:ScheduleListBigHeader id="ScheduleListBigHeader" runat="server"></uc1:ScheduleListBigHeader><BR>
							...
							<table id="table_ScheduleHeader" cellPadding="2" width="100%" border="1" runat="server">
								<tr>
									...
									<td align="center"><asp:button id="Button_BigView" runat="server" Text="大排程"></asp:button></td>
							...
							<uc1:BigView id="BigView" runat="server"></uc1:BigView>
