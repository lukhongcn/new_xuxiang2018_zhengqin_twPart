...
<%@ Register TagPrefix="uc1" TagName="OrderHeader" Src="controls/longfullElectrodeHeader.ascx" %>
<%@ Register TagPrefix="uc1" TagName="header" Src="controls/header.ascx" %>
<%@ Register TagPrefix="uc1" TagName="footer" Src="controls/footer.ascx" %>
<%@ Register TagPrefix="uc1" TagName="LeftMenu" Src="controls/LeftMenu.ascx" %>
<%@ Page language="c#" Codebehind="longfullElectrodeList.aspx.cs" AutoEventWireup="false" Inherits="ModuleWorkFlow.longfullElectrodeList" %>
				...
				<TBODY>
					...
					<TR>
						...
						<TD vAlign="top" width="79%">
							<P><uc1:longfullElectrodeHeader id="longfullElectrodeHeader" runat="server"></uc1:longfullElectrodeHeader><BR>
								...
								<asp:datagrid id="MainDataGrid" runat="server" Width="100%" AllowPaging="True" AutoGenerateColumns="False"
									...
									<Columns>
										...
										<asp:BoundColumn DataField="jiancun1" HeaderText="火花位(粗公)" DataFormatString="{0:0.00}"></asp:BoundColumn>
										<asp:BoundColumn DataField="count1" HeaderText="數量(粗)"></asp:BoundColumn>
										<asp:BoundColumn DataField="jiancun2" HeaderText="火花位(精公)" DataFormatString="{0:0.00}"></asp:BoundColumn>
										<asp:BoundColumn DataField="count2" HeaderText="數量(精)"></asp:BoundColumn>
										<asp:BoundColumn DataField="jiancun3" HeaderText="火花位(中公)" DataFormatString="{0:0.00}"></asp:BoundColumn>
										<asp:BoundColumn DataField="count3" HeaderText="數量(中)"></asp:BoundColumn>
										<asp:BoundColumn DataField="jiancun4" HeaderText="火花位(三角符號中公)" DataFormatString="{0:0.00}"></asp:BoundColumn>
										<asp:BoundColumn DataField="count4" HeaderText="數量(三角符號)"></asp:BoundColumn>
										...
										<asp:TemplateColumn>
											<ItemTemplate>
												<asp:HyperLink id=HyperLink_EditOthers runat="server" Text="基本信息編輯" NavigateUrl='<%#"longfullElectrodeEditOthers.aspx?moduleid="+Server.UrlEncode(DataBinder.Eval(Container, "DataItem.moduleid").ToString())+"&partno="+Server.UrlEncode(DataBinder.Eval(Container, "DataItem.PartNo").ToString())+"&pagecount=" + dpl_page.SelectedValue + "&lines="+txt_mod.Text %>'>
												</asp:HyperLink>
											</ItemTemplate>
										</asp:TemplateColumn>
