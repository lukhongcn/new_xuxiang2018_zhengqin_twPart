...
<%@ Page language="c#" Codebehind="OutSourceMerchindiseSiteView.aspx.cs" AutoEventWireup="false" Inherits="ModuleWorkFlow.OutsourceMerchindiseSiteView" %>
									...
									<TR>
										<TD vAlign="top">
											<TABLE width="100%" align="center" border="0">
												...
												<TR>
													<TD>
														<asp:label id="lab_zdno" runat="server" Text="零件編號">模具編號</asp:label></TD>
												...
												<TR>
													<TD>
														<asp:Label id="sourceDetailId" Text="外包編號" Runat="server"></asp:Label></TD>
													<TD style="WIDTH: 232px">
												...
												<TR>
													<TD colSpan="4">
														<asp:datagrid id="dg_MerchindiseDetailSite" runat="server" CellPadding="2" CellSpacing="2" AutoGenerateColumns="False">
															...
															<Columns>
																...
																<asp:TemplateColumn HeaderText="zdno">
																	<HeaderTemplate>
																		<asp:Label id="dg_header_zdno" runat="server">模具編號</asp:Label>
																	</HeaderTemplate>
																	<ItemTemplate>
																		&nbsp;
