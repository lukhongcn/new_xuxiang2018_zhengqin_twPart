...
<%@ Page language="c#" Codebehind="OutsourceApplyDesignList.aspx.cs" AutoEventWireup="false" Inherits="ModuleWorkFlow.OutsourceApplyDesignList" %>
												...
												<td colSpan="2">
													...
													<asp:datagrid id="dg_OutsourceApplyDesign" runat="server" AutoGenerateColumns="False" CellSpacing="2"
														...
														<Columns>
															...
															<asp:TemplateColumn>
																<ItemTemplate>
																	<asp:HyperLink id=HyperLink_Edit runat="server" Text="編輯" NavigateUrl='<%# "OutsourceApplyDesignView.aspx?func=edit&id="+DataBinder.Eval(Container, "DataItem.Id") %>'>
																	</asp:HyperLink>
																</ItemTemplate>
															</asp:TemplateColumn>
