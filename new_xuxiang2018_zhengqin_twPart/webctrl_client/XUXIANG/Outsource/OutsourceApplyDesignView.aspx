...
<%@ Page language="c#" Codebehind="OutsourceApplyDesignView.aspx.cs" AutoEventWireup="false" Inherits="ModuleWorkFlow.OutsourceApplyDesignView" %>
<%@ Register TagPrefix="uc1" TagName="OutsourceApplyDesignHeader" Src="control/OutsourceApplyDesignHeader.ascx" %>
						...
						<TD vAlign="top" width="79%">
							...
							<TABLE id="Table1" borderColor="#ccccff" cellSpacing="1" borderColorDark="#cccccc" cellPadding="0"
									...
									<td vAlign="top">
										<table width="100%" align="center" border="0">
											...
											<tr>
												...
												<td><asp:textbox id="txt_approver" runat="server" AutoPostBack="True"></asp:textbox><asp:dropdownlist id="dpl_approver" runat="server" AutoPostBack="True"></asp:dropdownlist></td>
											</tr>
											<tr>
								...
								<tr>
									<td vAlign="top">
										<table width="100%" align="center" border="0">
											<asp:label id="lab_detailId" runat="server" Text="" Visible="False"></asp:label>
											<TBODY>
												<tr>
												...
												<tr>
													<td><asp:label id="lab_requireDate" runat="server" Text="requireDate">需求日期</asp:label></td>
												...
												<tr>
													<td style="HEIGHT: 15px"><asp:label id="lab_moduleId" runat="server" Text="moduleId">模具編號</asp:label></td>
													<td style="WIDTH: 204px; HEIGHT: 15px"><asp:dropdownlist id="dpl_moduleId" runat="server" AutoPostBack="True"></asp:dropdownlist></td>
													<td style="HEIGHT: 15px"><asp:label id="lab_partNo" runat="server" Text="partNo">零件編號</asp:label></td>
													<td style="HEIGHT: 15px"><asp:dropdownlist id="dpl_partNo" runat="server" AutoPostBack="True"></asp:dropdownlist><asp:dropdownlist id="dpl_partno_id" runat="server" AutoPostBack="True"></asp:dropdownlist></td>
												</tr>
												<tr>
													<td style="HEIGHT: 16px"><asp:label id="lab_processId" runat="server" Text="processId">委外工序</asp:label></td>
													<td style="WIDTH: 204px; HEIGHT: 16px"><asp:dropdownlist id="dpl_processId" runat="server"></asp:dropdownlist><asp:button id="Button1" runat="server" Text="確認"></asp:button><asp:label id="lab_processno" runat="server" Visible="False"></asp:label></td>
								...
								<tr>
									<td style="HEIGHT: 16px"><asp:label id="lab_partcount" runat="server" Text="outsourceCount">零件數量</asp:label></td>
									<td style="HEIGHT: 16px"><asp:textbox id="txt_partcount" runat="server" ReadOnly="True" BackColor="Silver"></asp:textbox></td>
									<td><asp:label id="lab_materialProductId" runat="server" Text="materialProductId">零件名稱</asp:label></td>
									<td><asp:dropdownlist id="dpl_materialProductId" runat="server"></asp:dropdownlist></td>
								</tr>
								<tr>
								...
								<tr>
									<td><asp:label id="Label2" runat="server" Text="comment">備註</asp:label></td>
								...
								<tr>
									<td><asp:label id="lab_applyId" runat="server" Text="applyId" Visible="False">applyId</asp:label></td>
									<td style="WIDTH: 204px"><asp:textbox id="txt_applyId" runat="server" Visible="False"></asp:textbox></td>
									<td><asp:label id="lab_applyMerchindiseNo" runat="server" Text="applyMerchindiseNo" Visible="False">applyMerchindiseNo</asp:label></td>
									<td><asp:textbox id="txt_applyMerchindiseNo" runat="server" Visible="False"></asp:textbox></td>
								</tr>
								<tr>
								</tr>
								<tr>
									<td><asp:label id="lab_merchindiseNo" runat="server" Text="merchindiseNo" Visible="False">merchindiseNo</asp:label></td>
									<td style="WIDTH: 204px"><asp:textbox id="txt_merchindiseNo" runat="server" Visible="False"></asp:textbox></td>
									<td><asp:label id="lab_outProductNo" runat="server" Text="outProductNo" Visible="False">outProductNo</asp:label></td>
									<td><asp:textbox id="txt_outProductNo" runat="server" Visible="False"></asp:textbox></td>
								</tr>
								<tr>
									<td><asp:label id="lab_isInBound" runat="server" Text="isInBound" Visible="False">isInBound</asp:label></td>
									<td style="WIDTH: 204px"><asp:textbox id="txt_isInBound" runat="server" Visible="False"></asp:textbox></td>
									<td><asp:label id="lab_supply" runat="server" Text="supply" Visible="False">supply</asp:label></td>
									<td><asp:textbox id="txt_supply" runat="server" Visible="False"></asp:textbox></td>
								</tr>
								<tr>
									<td><asp:label id="lab_partnum" runat="server" Text="partnum" Visible="False">partnum</asp:label></td>
									<td style="WIDTH: 204px"><asp:textbox id="txt_partnum" runat="server" Visible="False"></asp:textbox></td>
									<td><asp:label id="lab_productNumber" runat="server" Text="productNumber" Visible="False">productNumber</asp:label></td>
								...
								<TR>
									<TD style="WIDTH: 346px; HEIGHT: 22px" colSpan="2"><asp:label id="func_detail" runat="server" Text="" Visible="False"></asp:label><asp:button id="btn_Detail" runat="server" Text="保存" Enabled="False"></asp:button></TD>
								</TR>
								<tr>
									<td colSpan="4"><asp:datagrid id="dg_OutSourceApplyDetail" runat="server" AutoGenerateColumns="False" CellSpacing="2"
											CellPadding="2">
											...
											<Columns>
												...
												<asp:TemplateColumn HeaderText="partNo">
													<HeaderTemplate>
														<asp:Label id="dg_header_partNo" runat="server">領件編號</asp:Label>
													</HeaderTemplate>
													<ItemTemplate>
														&nbsp;
