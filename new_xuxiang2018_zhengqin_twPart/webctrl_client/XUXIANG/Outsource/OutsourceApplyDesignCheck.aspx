										...
										<table width="100%" align="center" border="0">
											<TR>
												<TD style="HEIGHT: 17px" colSpan="2"><asp:label id="func" runat="server" Visible="False" Text=""></asp:label><asp:dropdownlist id="dpl_status" runat="server" AutoPostBack="True">
														...
														<asp:ListItem Value="CHECK_CONFUSE">拒絕通過</asp:ListItem>
													</asp:dropdownlist><asp:button id="btn_check" runat="server" Text="審核保存"></asp:button></TD>
											</TR>
											<tr>
												<td colSpan="2"><asp:datagrid id="dg_OutsourceApplyDesign" runat="server" CellPadding="2" CellSpacing="2" AutoGenerateColumns="False"
														...
														<Columns>
															<asp:TemplateColumn>
																<HeaderTemplate>
																	<asp:Label id="dg_header_rdl" runat="server">通過|拒絕|未通過</asp:Label>
																</HeaderTemplate>
																<ItemTemplate>
															...
															<asp:TemplateColumn HeaderText="partId">
																<HeaderTemplate>
																	<asp:Label id="dg_header_partId" runat="server">零件流水號</asp:Label>
																</HeaderTemplate>
																<ItemTemplate>
																	&nbsp;
