<%@ Page language="c#" Codebehind="xuxiangOutSourceMerchindiseSiteList.aspx.cs" AutoEventWireup="false" Inherits="ModuleWorkFlow.xuxiangOutsourceMerchindiseSiteList" %>
											...
											<tr>
												<td colSpan="2"><asp:datagrid id="dg_MerchindiseSite" runat="server" CellPadding="2" CellSpacing="2" AutoGenerateColumns="False"
														...
														<Columns>
															...
															<asp:TemplateColumn>
																<ItemTemplate>
																	<asp:HyperLink id=HyperLink_Edit runat="server" Text="編輯" NavigateUrl='<%# "xuxiangOutsourceMerchindiseSiteView.aspx?func=edit&id="+DataBinder.Eval(Container, "DataItem.Id") %>'>
																	</asp:HyperLink>
																</ItemTemplate>
															</asp:TemplateColumn>
