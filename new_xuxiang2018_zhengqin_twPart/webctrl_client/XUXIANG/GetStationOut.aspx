<%@ Page language="c#" Codebehind="GetStationOut.aspx.cs" AutoEventWireup="false" Inherits="ModuleWorkFlow.GetStationOut" %>
						...
						<TD vAlign="top" width="79%"><uc1:getstationouthearder id="GetStationOutHearder" runat="server"></uc1:getstationouthearder>
							...
							<table width="100%" align="center" border="0">
								...
								<tr>
									...
									<td><asp:label id="lab_user_value" runat="server"></asp:label><asp:label id="lab_username" Visible="false" Runat="server"></asp:label></td>
									...
									<td><asp:label id="lab_action" runat="server" Text="出貨">出貨</asp:label></td>
