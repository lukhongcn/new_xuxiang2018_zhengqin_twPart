<%@ Page language="c#" Codebehind="ModulePartOverDoneView.aspx.cs" AutoEventWireup="false" Inherits="ModuleWorkFlow.ModulePartOverDoneView" %>
						...
						<TD vAlign="top" width="79%">
							...
							<asp:datagrid id="MainDataGrid" runat="server" CellPadding="2" CellSpacing="2" Width="100%" AutoGenerateColumns="False"
								...
								<Columns>
									...
									<asp:BoundColumn DataField="PartNo_Id" HeaderText="零件ID編號" Visible="False"></asp:BoundColumn>
									...
									<asp:BoundColumn DataField="TryDate1" HeaderText="T1" DataFormatString="{0:yyyy-MM-dd}" Visible="False"></asp:BoundColumn>
								</Columns>
