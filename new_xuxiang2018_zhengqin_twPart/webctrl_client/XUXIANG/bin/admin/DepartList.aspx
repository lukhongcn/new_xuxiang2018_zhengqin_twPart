					...
					<TR>
						...
						<TD vAlign="top" width="79%">
							...
							<asp:datagrid id="MainDataGrid" runat="server" AutoGenerateColumns="False" Width="100%" CellSpacing="2"
								...
								<Columns>
									<asp:BoundColumn DataField="DepartmentId" HeaderText="部門編號"></asp:BoundColumn>
									<asp:BoundColumn DataField="DepartmentName" HeaderText="部門名稱"></asp:BoundColumn>
									<asp:TemplateColumn HeaderText="功能">
										<ItemTemplate>
											<asp:HyperLink id=HyperLink_Edit runat="server" Text="編輯" NavigateUrl='<%# "DepartAddEdit.aspx?func=edit&departid="+DataBinder.Eval(Container, "DataItem.departmentid") %>'>
											</asp:HyperLink>
										</ItemTemplate>
									</asp:TemplateColumn>
								</Columns>
