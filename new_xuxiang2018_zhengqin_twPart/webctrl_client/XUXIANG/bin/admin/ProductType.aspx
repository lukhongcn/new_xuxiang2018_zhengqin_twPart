<%@ Page language="c#" Codebehind="ProductType.aspx.cs" AutoEventWireup="false" Inherits="ModuleWorkFlow.admin.ProductType" %>
								...
								<tr>
									<td vAlign="top">
										<table width="100%" align="center" border="0">
											<TR>
												<TD>產品類型編號</TD>
												<TD><asp:textbox id="txt_producttype" runat="server"></asp:textbox></TD>
											</TR>
											<TR>
												<TD>產品類型名稱</TD>
												<TD><asp:textbox id="txt_productname" runat="server"></asp:textbox></TD>
											</TR>
											<TR>
