...
<%@ Page language="c#" Codebehind="ProductTypeList.aspx.cs" AutoEventWireup="false" Inherits="ModuleWorkFlow.ProductType" %>
								...
								<tr>
									<td vAlign="top">
										<table width="100%" align="center" border="0">
											...
											<tr>
												<td><asp:Label ID="lab_TypeId" runat="server" Text="產品類型編號"></asp:Label></td>
												<td><asp:textbox id="txt_TypeId" runat="server"></asp:textbox></td>
											</tr>
											<tr>
												<td><asp:Label ID="lab_TypeName" runat="server" Text="產品類型名稱"></asp:Label></td>
												<td><asp:textbox id="txt_TypeName" runat="server"></asp:textbox></td>
											</tr>
											<TR>
											...
											<tr>
												<td colSpan="2">
													<asp:datagrid id="dg_ProductType" runat="server" AutoGenerateColumns="False" CellSpacing="2" CellPadding="2">
														...
														<Columns>
															...
															<asp:TemplateColumn HeaderText="TypeId">
																<HeaderTemplate>
																	<asp:Label id="dg_header_TypeId" runat="server">產品類型編號</asp:Label>
																</HeaderTemplate>
																<ItemTemplate>
																	&nbsp;
																...
																<EditItemTemplate>
																	<asp:textbox id="dg_txt_TypeId" Width="40" runat="server" Text='<%#DataBinder.Eval(Container, "DataItem.TypeId") %>'/>
																</EditItemTemplate>
															</asp:TemplateColumn>
															<asp:TemplateColumn HeaderText="TypeName">
																<HeaderTemplate>
																	<asp:Label id="dg_header_TypeName" runat="server">產品類型名稱</asp:Label>
																</HeaderTemplate>
																<ItemTemplate>
																	&nbsp;
