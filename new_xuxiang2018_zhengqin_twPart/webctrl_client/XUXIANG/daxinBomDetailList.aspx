...
<%@ Page language="c#" Codebehind="daxinBomDetailList.aspx.cs" AutoEventWireup="false" Inherits="ModuleWorkFlow.daxinBomDetailList" %>
			...
			<TABLE id="Table2" cellSpacing="0" cellPadding="0" width="100%" border="0">
				<TBODY>
					...
					<tr>
						...
						<TD width="1%">&nbsp;</TD>
						<TD vAlign="top" width="79%"><uc1:daxinbomdetailheader id="daxinBomDetailHeader" runat="server"></uc1:daxinbomdetailheader>
								...
								<tr>
									<td>
										<div align="left"><FONT face="新細明體">
												...
												<asp:button id="btn_search" Text="模具編號查詢" Runat="server"></asp:button></FONT></div>
									</td>
								</tr>
							</table>
							<hr>
								...
								<tr>
									<td vAlign="top">
										<table width="100%" align="center" border="0">
											...
											<tr>
												<td colSpan="2"><asp:datagrid id="dg_BomDetail" runat="server" CellPadding="2" CellSpacing="2" AutoGenerateColumns="False"
														AllowPaging="True">
														...
														<Columns>
															...
															<asp:TemplateColumn HeaderText="moduleId">
																<HeaderTemplate>
																	<asp:Label id="dg_haeder_moduleId" runat="server" text='<%#System.Configuration.ConfigurationSettings.AppSettings["ModuleIdShow"]%>'>
																	</asp:Label>
																</HeaderTemplate>
																<ItemTemplate>
																	&nbsp;
															...
															<asp:TemplateColumn>
																<ItemTemplate>
																	&nbsp;
																	<asp:HyperLink id=HyperLink_bom runat="server" Text="BOM詳細明細編輯" NavigateUrl='<%# "daxinBomDetailView.aspx?func=edit&id="+DataBinder.Eval(Container, "DataItem.Id") %>'>
																	</asp:HyperLink>
																</ItemTemplate>
															</asp:TemplateColumn>
															<asp:TemplateColumn>
																<ItemTemplate>
																	&nbsp;
																	<asp:HyperLink ID="HyperLink_Eitd" runat="server" text="BOM編輯" NavigateUrl='<%# "daxinBomDetailViewExcel.aspx?func=edit&id="+DataBinder.Eval(Container, "DataItem.Id") %>'>
																	</asp:HyperLink>
																</ItemTemplate>
															</asp:TemplateColumn>
															<asp:ButtonColumn Text="&lt;div onclick=&quot;javascript:return confirm('確認刪除?')&quot;&gt;刪除&lt;/div&gt;"
																HeaderText="動作" CommandName="Delete"></asp:ButtonColumn>
															<asp:ButtonColumn Text="打印報表" HeaderText="動作" CommandName="PRINT" Visible="False"></asp:ButtonColumn>
														</Columns>
											...
											<tr>
												<td colSpan="4"><asp:datagrid id="Datagrid_bomdetail" runat="server" Visible="False" CellPadding="2" CellSpacing="2"
														...
														<Columns>
															...
															<asp:TemplateColumn HeaderText="uglyspec">
																<HeaderTemplate>
																	<asp:Label id="dg_header_uglyspec" runat="server" text="規格(備料)"></asp:Label>
																</HeaderTemplate>
																<ItemTemplate>
																	&nbsp;
															...
															<asp:TemplateColumn HeaderText="moduleId">
																<HeaderTemplate>
																	<asp:Label id="dg_header_moduleId" runat="server" text="備註"></asp:Label>
																</HeaderTemplate>
																<ItemTemplate>
																	&nbsp;
