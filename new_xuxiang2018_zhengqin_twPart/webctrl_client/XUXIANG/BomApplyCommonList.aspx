...
<%@ Page language="c#" Codebehind="BomApplyCommonList.aspx.cs" AutoEventWireup="false" Inherits="ModuleWorkFlow.BomApplyCommonList" %>
			...
			<TABLE id="Table2" cellSpacing="0" cellPadding="0" width="100%" border="0">
				<TBODY>
					...
					<tr>
						...
						<TD width="1%">&nbsp;</TD>
						<TD vAlign="top" width="79%"><uc1:bomapplycommonheader id="BomApplyCommonHeader" runat="server"></uc1:bomapplycommonheader>
											...
											<tr>
												<td colSpan="2"><asp:datagrid id="dg_BomApplyDetail" runat="server" CellPadding="2" CellSpacing="2" AutoGenerateColumns="False">
														...
														<Columns>
															...
															<asp:TemplateColumn>
																<ItemTemplate>
																	<asp:HyperLink id=HyperLink_bom runat="server" Text="申購明細編輯" NavigateUrl='<%# "BomApplyCommonView.aspx?func=edit&id="+DataBinder.Eval(Container, "DataItem.Id") %>'>
																	</asp:HyperLink>
																</ItemTemplate>
															</asp:TemplateColumn>
															<asp:TemplateColumn>
																<ItemTemplate>
																	<asp:HyperLink ID="HyperLink_Eitd" runat="server" text="申購編輯" NavigateUrl='<%# "BomApplyCommonDetailView.aspx?func=edit&id="+DataBinder.Eval(Container, "DataItem.Id") %>'>
																	</asp:HyperLink>
																</ItemTemplate>
															</asp:TemplateColumn>
