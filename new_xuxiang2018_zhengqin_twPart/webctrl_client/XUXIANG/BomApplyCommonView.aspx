<%@ Page language="c#" Codebehind="BomApplyCommonView.aspx.cs" AutoEventWireup="false" Inherits="ModuleWorkFlow.admin.BomApplyCommonView" %>
										...
										<td colSpan="4"><asp:datagrid id="dg_BomApplyDetail" runat="server" Width="600" AutoGenerateColumns="False" CellSpacing="2"
												...
												<Columns>
													...
													<asp:TemplateColumn HeaderText="partName">
														<HeaderTemplate>
															<asp:Label id="dg_header_partName" runat="server" text="物料名稱"></asp:Label>
														</HeaderTemplate>
														<ItemTemplate>
