<%@ Page language="c#" Codebehind="ViewFactMiddleScheduleList.aspx.cs" AutoEventWireup="false" Inherits="ModuleWorkFlow.ViewFactMiddleScheduleList" %>
				...
				<TBODY>
					...
					<TR>
						...
						<TD vAlign="top" width="92%"><A href="default.aspx">返回首頁</A>
							...
							<BR>
							<div style="OVERFLOW-Y: scroll; FONT-SIZE: 10px; OVERFLOW-X: scroll; WIDTH: 980px; BORDER-TOP-STYLE: ridge; FONT-FAMILY: Arial; BORDER-RIGHT-STYLE: ridge; BORDER-LEFT-STYLE: ridge; HEIGHT: 450px; BORDER-BOTTOM-STYLE: ridge"><asp:datagrid id="MainDataGrid" runat="server" AutoGenerateColumns="False" CellPadding="0" CellSpacing="0">
