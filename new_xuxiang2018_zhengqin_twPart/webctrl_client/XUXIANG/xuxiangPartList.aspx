...
<%@ Page language="c#" Codebehind="xuxiangPartList.aspx.cs" AutoEventWireup="false" Inherits="ModuleWorkFlow.xuxiangPartList" %>
			...
			<TABLE id="Table2" cellSpacing="0" cellPadding="0" width="100%" border="0">
				<TBODY>
					...
					<TR>
						...
						<TD width="1%">&nbsp;</TD>
						<TD vAlign="top"><uc1:xuxiangPartHeader id="xuxiangPartHeader" runat="server"></uc1:xuxiangPartHeader><BR>
							選擇工令單號<asp:dropdownlist id="Dropdownlist_ModuleId" runat="server" AutoPostBack="True"></asp:dropdownlist>
							...
							<asp:datagrid id="MainDataGrid" runat="server" Width="100%" AllowPaging="True" AutoGenerateColumns="False"
								...
								<Columns>
									...
									<asp:TemplateColumn>
										<ItemTemplate>
											<asp:HyperLink id=HyperLink_EditOthers runat="server" Text="基本信息編輯" NavigateUrl='<%# "xuxiangPartEditOthers.aspx?moduleid="+DataBinder.Eval(Container, "DataItem.moduleid")+"&partno="+DataBinder.Eval(Container, "DataItem.PartNo")+"&search="+lab_search.Text+"&pagecount=" + dpl_page.SelectedValue +"&lines="+ txt_mod.Text %>'>
											</asp:HyperLink>
										</ItemTemplate>
									</asp:TemplateColumn>
