<%@ Page language="c#" Codebehind="mileElectrodeEditProcess.aspx.cs" AutoEventWireup="false" Inherits="ModuleWorkFlow.mileElectrodeEditProcess"%>
						...
						<TD vAlign="top" width="79%"><uc1:mileElectrodeHeader id="mileElectrodeHeader" runat="server"></uc1:mileElectrodeHeader><BR>
							<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="1">
								<TBODY>
									...
									<tr>
										<TD>相關零件</TD>
										<TD><asp:label id="lab_relationpart" runat="server"></asp:label></TD>
										<TD>相關工序</TD>
										<TD><asp:label id="lab_relationpartprocessno" runat="server"></asp:label></TD>
									</tr>
									<TR>
										<TD colSpan="6"><asp:label id="Label_Skelection" Runat="server" Visible="False"></asp:label>&nbsp;&nbsp;
											...
											<asp:checkbox id="CheckBox_ProcessUpdate" runat="server" Visible="False"></asp:checkbox><asp:label id="Label1" runat="server" Visible="False"></asp:label></TD>
									</TR>
									<TR>
										<TD>工序設定</TD>
										<TD colSpan="5">
