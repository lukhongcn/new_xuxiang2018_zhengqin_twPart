						...
						<TD vAlign="top" width="79%"><uc1:mileelectrodeheader id="mileElectrodeHeader" runat="server"></uc1:mileelectrodeheader><BR>
							<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="1">
								<TBODY>
									...
									<tr>
										<td>零件類別</td>
										<td colSpan="3"><asp:button id="Button1" runat="server" Text="類別查詢"></asp:button><asp:textbox id="txt_parttypeid" runat="server" ReadOnly="True">()</asp:textbox><asp:textbox id="txt_name" runat="server" ReadOnly="True">[]</asp:textbox></td>
									</tr>
									<TR>
										<TD>電極編號</TD>
									...
									<tr>
										<TD width="10%">相關零件</TD>
										<TD width="40%"><asp:textbox id="txt_RelationPart" runat="server"></asp:textbox><asp:button id="but_part" Text="選擇零件" Runat="server"></asp:button></TD>
										<TD width="10%">相關工序</TD>
