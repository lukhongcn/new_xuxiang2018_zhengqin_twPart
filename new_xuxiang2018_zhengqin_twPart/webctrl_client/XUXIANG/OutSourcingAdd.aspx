<%@ Page language="c#" Codebehind="OutSourcingAdd.aspx.cs" AutoEventWireup="false" Inherits="ModuleWorkFlow.OutSourcingAdd" %>
									...
									<TR>
										<td>
											<TABLE id="tbl_selectcond" cellSpacing="0" cellPadding="0" width="100%" border="0">
												<tr>
													<TD><asp:radiobutton id="rad_module" AutoPostBack="True" Text="模具外包" Runat="server" GroupName="1"></asp:radiobutton></TD>
												</tr>
												<tr>
													<TD><asp:radiobutton id="rad_partno" AutoPostBack="True" Text="同類型零件外包" Runat="server" GroupName="1"></asp:radiobutton></TD>
												</tr>
												<tr>
													<TD><asp:radiobutton id="rad_partnoid" AutoPostBack="True" Text="單個零件外包" Runat="server" GroupName="1"
										...
										<td>
											<TABLE id="tbl_selectmodulepartno" cellSpacing="0" cellPadding="0" width="100%" border="0">
												<tr>
													<TD>選擇客戶&nbsp;<asp:dropdownlist id="drp_customerlist" AutoPostBack="True" Runat="server"></asp:dropdownlist></TD>
												</tr>
												<tr>
													<TD>選擇模具&nbsp;<asp:dropdownlist id="drp_modulelist" AutoPostBack="True" Runat="server"></asp:dropdownlist></TD>
												</tr>
												<tr>
													<TD>選擇零件&nbsp;<asp:dropdownlist id="drp_partnolist" AutoPostBack="True" Runat="server"></asp:dropdownlist></TD>
												</tr>
												<tr>
													<TD>選擇零件ID&nbsp;<asp:dropdownlist id="drp_partnoidlist" AutoPostBack="True" Runat="server"></asp:dropdownlist></TD>
												</tr>
											</TABLE>
										</td>
									</TR>
