<%@ Page language="c#" Codebehind="TrySearch.aspx.cs" AutoEventWireup="false" Inherits="ModuleWorkFlow.Try.TrySearch" %>
								...
								<tr>
									<td vAlign="top">
										<table width="100%" align="center" border="0">
											<TR>
											<tr>
												<td style="HEIGHT: 24px"><asp:Label ID="lab_productmaterialno" runat="server" Text="原料編號"></asp:Label></td>
												<td style="HEIGHT: 24px"><asp:textbox id="txt_productmaterialno" runat="server"></asp:textbox><FONT face="宋體">&nbsp;
														<asp:DropDownList id="dpl_MaterialProduct" runat="server" AutoPostBack="True" Enabled="true"></asp:DropDownList>&nbsp;
													</FONT>
								...
								<tr>
									<td colSpan="2"><asp:datagrid id="dg_ProductMaterialInventory" runat="server" CellPadding="2" CellSpacing="2"
											...
											<Columns>
												...
												<asp:TemplateColumn HeaderText="id">
													<HeaderTemplate>
														<asp:Label id="dg_header_productmaterialno" runat="server">原料編號</asp:Label>
													</HeaderTemplate>
													<ItemTemplate>
														&nbsp;
												...
												<asp:TemplateColumn HeaderText="name">
													<HeaderTemplate>
														<asp:Label id="dg_header_name" runat="server">原料名稱</asp:Label>
													</HeaderTemplate>
													<ItemTemplate>
														&nbsp;
												...
												<asp:TemplateColumn HeaderText="inventorycount" Visible="False">
													<HeaderTemplate>
														<asp:Label id="lab_inventorycount" runat="server">原料庫存數量</asp:Label>
													</HeaderTemplate>
													<ItemTemplate>
														&nbsp;
