...
<%@ Page language="c#" Codebehind="xuxiangPartDesignAddEdit.aspx.cs" AutoEventWireup="false" Inherits="ModuleWorkFlow.admin.xuxiangPartDesignAddEdit" %>
												...
												<tr>
													...
													<td vAlign="top"><asp:datagrid id="MainDataGrid" runat="server" AutoGenerateColumns="False" Width="100%">
															...
															<Columns>
																...
																<asp:TemplateColumn HeaderText="關聯工序" Visible="False">
																	<ItemTemplate>
																		<asp:Label id="dg_lab_partprocessid" Runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.PartProcessId") %>'>
																		</asp:Label>
																	</ItemTemplate>
																</asp:TemplateColumn>
