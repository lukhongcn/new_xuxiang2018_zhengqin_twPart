<%@ Page language="c#" Codebehind="mileOutInventoryView.aspx.cs" AutoEventWireup="false" Inherits="ModuleWorkFlow.admin.mileOutInventoryView" %>
								...
								<tr>
									<td vAlign="top">
										<table width="100%" align="center" border="0">
											...
											<tr>
												<td style="HEIGHT: 12px"><asp:label id="lab_myNo" runat="server" Text="出庫單號"></asp:label></td>
												<td style="HEIGHT: 12px"><asp:textbox id="txt_myNo" runat="server" ReadOnly="True"></asp:textbox></td>
											...
											<tr>
												<td style="HEIGHT: 22px"><asp:label id="lab_outDepartmentid" runat="server" Text="部門"></asp:label></td>
												<td style="HEIGHT: 22px"><asp:dropdownlist id="dpl_outDepartmentid" runat="server"></asp:dropdownlist></td>
												<td style="HEIGHT: 22px"><asp:label id="lab_comment" runat="server" Text="備註"></asp:label></td>
												<td style="HEIGHT: 22px"><asp:textbox id="txt_comment" runat="server"></asp:textbox></td>
												<td style="HEIGHT: 22px"><asp:label id="lab_inventoryManager" runat="server" Text="倉庫員"></asp:label></td>
												<td style="HEIGHT: 22px">
													<asp:TextBox id="txt_inventoryManager" runat="server" AutoPostBack="True"></asp:TextBox><asp:dropdownlist id="dpl_inventoryManager" runat="server" AutoPostBack="True"></asp:dropdownlist></td>
											</tr>
											<tr>
												<td><asp:label id="lab_inventoryOuter" runat="server" Text="領料人"></asp:label></td>
												<td>
													<asp:TextBox id="txt_inventoryOuter" runat="server" AutoPostBack="True"></asp:TextBox><asp:dropdownlist id="dpl_inventoryOuter" runat="server" AutoPostBack="True"></asp:dropdownlist></td>
												<td><asp:label id="lab_shelfId" runat="server" Text="庫位">庫位</asp:label></td>
												<td><asp:DropDownList id="dpl_shelfId" runat="server"></asp:DropDownList></td>
														...
														<TABLE id="Table3" width="100%" align="center" border="0">
															...
															<TR>
																<TD colSpan="2">
																	...
																	<asp:Label id="lab_Detail_Id" runat="server" Visible="False"></asp:Label>
																	<asp:Button id="btn_print" runat="server" Text="報表打印"></asp:Button>
																	<asp:label id="lab_print" runat="server"></asp:label>
																	<asp:Label id="lab_checkmyno" runat="server" Visible="False"></asp:Label></TD>
															</TR>
														</TABLE>
												<TR>
													<TD colSpan="2">
														<asp:datagrid id="dg_OutInventoryDetail" runat="server" AllowPaging="True" AutoGenerateColumns="False"
