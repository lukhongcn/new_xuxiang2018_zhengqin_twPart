<%@ Page language="c#" Codebehind="InInventoryView.aspx.cs" AutoEventWireup="false" Inherits="ModuleWorkFlow.admin.InInventoryView" %>
								...
								<tr>
									<td vAlign="top">
										<table width="100%" align="center" border="0">
											...
											<TBODY>
												<tr>
													<td><asp:label id="lab_myNo" runat="server" Text="入庫編號"></asp:label></td>
													<td><asp:textbox id="txt_myNo" runat="server"></asp:textbox></td>
													<td><asp:label id="lab_inventoryManage" runat="server" Text="倉庫員"></asp:label></td>
													<td><asp:dropdownlist id="dpl_inventoryManage" runat="server"></asp:dropdownlist></td>
													<td><asp:label id="lab_inventoryTypeId" runat="server" Text="入庫類別"></asp:label></td>
													<td><asp:dropdownlist id="dpl_inventoryTypeId" runat="server"></asp:dropdownlist></td>
												</tr>
												<tr>
													...
													<TD vAlign="top">
														<TABLE width="100%" align="center" border="0">
															...
															<TR>
																...
																<TD>
																	<asp:textbox id="txt_inInventoryWeight" runat="server"></asp:textbox></TD>
															</TR>
															<TR>
																<TD>
																...
																<TD>
																	<asp:textbox id="txt_price" runat="server" Enabled="False"></asp:textbox></TD>
																<TD>
																	<asp:label id="Label2" runat="server" Text="備註"></asp:label></TD>
																<TD>
																	<asp:textbox id="txt_comment_Detail" runat="server"></asp:textbox></TD>
																<TD>
																	<asp:label id="lab_inInventoryId" runat="server" Visible="False" Text=""></asp:label></TD>
															<TR>
																<TD>
