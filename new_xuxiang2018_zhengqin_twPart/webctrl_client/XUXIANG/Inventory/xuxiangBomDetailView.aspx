...
<%@ Page language="c#" Codebehind="xuxiangBomDetailView.aspx.cs" AutoEventWireup="false" Inherits="ModuleWorkFlow.admin.xuxiangBomDetailView" %>
							...
							<TABLE id="Table1" borderColor="#ccccff" cellSpacing="1" borderColorDark="#cccccc" cellPadding="0"
								...
								<TBODY>
									<tr>
										...
										<td><asp:label id="lab_moduleid" runat="server" Text="模具編號">工令單號</asp:label></td>
									...
									<tr>
										<td><asp:Label ID="lab_moduleComment" Runat="server" Text="模具編號"></asp:Label></td>
									...
									<tr>
										...
										<td><asp:Label ID="lab_uglySpec" Runat="server" text="規格（毛）"></asp:Label></td>
									...
									<tr>
										...
										<td><asp:Label ID="lab_uglyLength" Runat="server" Text="長（毛）"></asp:Label></td>
										<td><asp:TextBox ID="txt_uglyLength" Runat="server"></asp:TextBox></td>
									</tr>
									<tr>
										<td><asp:Label ID="lab_length" Runat="server" Text="長（實）"></asp:Label></td>
									...
									<tr>
										...
										<td><asp:Label ID="lab_moldSkleton" Runat="server" Text="模架"></asp:Label></td>
										<td><asp:TextBox ID="txt_moldSkleton" Runat="server"></asp:TextBox></td>
									</tr>
									<tr>
										<td><asp:Label ID="lab_stand" Runat="server" Text="標準件"></asp:Label></td>
										<td><asp:TextBox ID="txt_stand" Runat="server"></asp:TextBox></td>
										<td><asp:Label ID="lab_skillRequirement" Runat="server" text="HRC"></asp:Label></td>
									...
									<tr>
										...
										<td>
											<asp:DropDownList id="dpl_isMerchindise" Runat="server">
												<asp:ListItem Value="0">否</asp:ListItem>
												<asp:ListItem Value="1">是</asp:ListItem>
											</asp:DropDownList></td>
										<td><asp:Label ID="lab_heatProcess" Runat="server" Text="熱處理"></asp:Label></td>
									...
									<tr>
										<td><asp:Label ID="lab_cryogenic" Runat="server" Text="深冷"></asp:Label></td>
										<td><asp:TextBox ID="txt_cryogenic" Runat="server"></asp:TextBox></td>
										<td><asp:Label ID="lab_request" Runat="server" Text="要求"></asp:Label></td>
										<td><asp:TextBox ID="txt_request" Runat="server"></asp:TextBox></td>
									</tr>
									<tr>
										<td><asp:label ID="lab_materialer" Runat="server" Text="領料人"></asp:label></td>
									...
									<tr>
										<td colSpan="4"><asp:datagrid id="dg_BomDetail" runat="server" CellPadding="2" CellSpacing="2" AutoGenerateColumns="False">
												...
												<Columns>
													...
													<asp:TemplateColumn HeaderText="moduleId">
														<HeaderTemplate>
															<asp:Label id="dg_header_moduleComment" runat="server" text="模具編號"></asp:Label>
														</HeaderTemplate>
														<ItemTemplate>
															&nbsp;
