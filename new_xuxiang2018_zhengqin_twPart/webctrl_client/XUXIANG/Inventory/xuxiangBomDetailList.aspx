											...
											<tr>
												<td colSpan="2"><asp:datagrid id="dg_BomDetail" runat="server" CellPadding="2" CellSpacing="2" AutoGenerateColumns="False">
														...
														<Columns>
															...
															<asp:TemplateColumn HeaderText="projectname" Visible="False">
																<HeaderTemplate>
															...
															<asp:EditCommandColumn ButtonType="LinkButton" UpdateText="更新" runat="server" EditText="Bom明細"></asp:EditCommandColumn>
															<asp:TemplateColumn>
																<ItemTemplate>
																	&nbsp;
