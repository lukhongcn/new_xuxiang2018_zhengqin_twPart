								...
								<tr>
									<td vAlign="top">
										<table width="100%" align="center" border="0">
											...
											<tr>
												<td><asp:label id="lab_myNo" runat="server" Text="單號"></asp:label></td>
												<td><asp:textbox id="txt_myNo" runat="server" ReadOnly="True"></asp:textbox></td>
											</tr>
											<tr>
												<td><asp:label id="lab_productMaterialId" runat="server" Text="料品名稱">料品編號</asp:label></td>
												<td><asp:textbox id="txt_productmaterialno" runat="server"></asp:textbox>
													<asp:Button id="btn_detail" runat="server" Text="查詢"></asp:Button></td>
											</tr>
											<tr>
												<td><asp:Label ID="lab_name" Runat="server" Text="料品名稱"></asp:Label></td>
											...
											<tr>
												<td><asp:label id="lab_inventoryPCS" runat="server" Text="入庫編號"></asp:label></td>
												<td><asp:textbox id="txt_inventoryPCS" runat="server" ReadOnly="True"></asp:textbox></td>
											</tr>
											<tr>
												<td><asp:label id="lab_shelfNoId" runat="server" Text="庫位"></asp:label></td>
												<td><asp:dropdownlist id="dpl_shelfNoId" runat="server"></asp:dropdownlist></td>
											</tr>
											<tr>
												<td><asp:label id="lab_inventoryCount" runat="server" Text="入庫數量"></asp:label></td>
											...
											<tr>
												<td><asp:label id="lab_inventoryWeight" runat="server" Text="入庫重量"></asp:label></td>
