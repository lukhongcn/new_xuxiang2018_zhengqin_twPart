...
<%@ Page language="c#" Codebehind="MerchindiseJdeView.aspx.cs" AutoEventWireup="false" Inherits="ModuleWorkFlow.MerchindiseJdeView" %>
				...
				<TBODY>
					...
					<tr>
						...
						<TD vAlign="top" width="79%">
							...
							<br>
							<pre>
							<asp:datagrid id="dg_merchindise" runat="server" PageSize="25" AutoGenerateColumns="False" AllowPaging="True">
								<Columns>
									<asp:BoundColumn DataField="JModuleId" ReadOnly="True" HeaderText="模具編碼"></asp:BoundColumn>
									<asp:BoundColumn DataField="MerchindiseSpecification" ReadOnly="True" HeaderText="規格"></asp:BoundColumn>
									<asp:BoundColumn DataField="JErpSpecification" ReadOnly="True" HeaderText="ERP規格"></asp:BoundColumn>
									<asp:BoundColumn DataField="JWeight" ReadOnly="True" HeaderText="重量"></asp:BoundColumn>
