      ...
      cellPadding=0 width="100%" align=center borderColorLight=#ccccff border=1 
       runat="server">
        ...
        <tr>
          ...
          <td><asp:label id=lab_uglySpec text="規格（備料）" Runat="server"></asp:label></TD>
        ...
        <TR>
          <TD colSpan=4><asp:label id=func runat="server" Text="" Visible="False"></asp:label><asp:button id=btn_add_edit runat="server" Text="保存"></asp:button></TD></TR>
        <tr>
          <td colSpan=4><asp:datagrid id=dg_BomDetail runat="server" AutoGenerateColumns="False" CellSpacing="2" CellPadding="2">
												...
												<Columns>
													...
													<asp:ButtonColumn Text="&lt;div onclick=&quot;javascript:return confirm('確認刪除?')&quot;&gt;刪除&lt;/div&gt;" CommandName="Delete"></asp:ButtonColumn>
												</Columns>
