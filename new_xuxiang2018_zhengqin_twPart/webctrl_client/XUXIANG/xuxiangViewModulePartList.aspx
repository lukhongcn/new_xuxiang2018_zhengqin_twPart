<%@ Page language="c#" Codebehind="xuxiangViewModulePartList.aspx.cs" AutoEventWireup="false" Inherits="ModuleWorkFlow.xuxiangViewModulePartList" %>
					...
					<TR>
						...
						<TD vAlign="top" width="79%">
							...
							<TABLE id="TableView" width="100%" border="1" runat="server">
								<TR>
									<TD width="50%">當前選擇<%= System.Configuration.ConfigurationSettings.AppSettings["ModuleIdShow"]%>為<asp:label id="Label_ModuleId" runat="server"></asp:label></TD>
							...
							<uc1:midview id="MidView" runat="server"></uc1:midview><uc1:smallview id="SmallView" runat="server"></uc1:smallview><uc1:newdesignview id="NewDesignView" runat="server"></uc1:newdesignview><uc1:partunnormal id="PartUnnormal" runat="server"></uc1:partunnormal><br>
