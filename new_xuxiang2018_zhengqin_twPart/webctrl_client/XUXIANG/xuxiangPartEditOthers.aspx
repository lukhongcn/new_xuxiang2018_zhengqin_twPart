...
<%@ Page language="c#" Codebehind="xuxiangPartEditOthers.aspx.cs" AutoEventWireup="false" Inherits="ModuleWorkFlow.xuxiangPartEditOthers" smartNavigation="True"%>
							...
							<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="1">
								<TBODY>
									...
									<TR>
										...
										<td>模具編號</td>
										<td><asp:label id="txt_moduleComment" Runat="server"></asp:label></td>
									</TR>
									<TR>
										<TD>材質</TD>
									...
									<TR>
										<TD>數量</TD>
										<TD><asp:textbox id="TextBox_PartCount" runat="server"></asp:textbox><asp:regularexpressionvalidator id="RegularExpressionValidator1" runat="server" ValidationExpression="[0-9.]{1,}"
												ErrorMessage="請輸入數字類型" ControlToValidate="TextBox_PartCount"></asp:regularexpressionvalidator></TD>
										<TD>等級設定</TD>
							...
							<TABLE id="Table3" borderColor="#000660" borderColorDark="#000066" width="100%" align="center"
								...
								<TR vAlign="middle">
									...
									<TD class="msg" width="85%">&nbsp;&nbsp;
										<asp:label id="Label_Message" runat="server" Font-Bold="True" ForeColor="red"></asp:label><asp:label id="Label_HiddenPartCount" runat="server" Visible="False"></asp:label><asp:label id="lab_hidden_pagecount" runat="server" Visible="False"></asp:label><asp:label id="lab_hidden_lines" runat="server" Visible="False"></asp:label></TD>
								</TR>
							</TABLE>
						</TD>
					</TR>
