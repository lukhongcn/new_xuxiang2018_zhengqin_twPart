<%@ Page language="c#" Codebehind="PartOutInventoryDetailList.aspx.cs" AutoEventWireup="false" Inherits="ModuleWorkFlow.PartOutInventoryDetailList" %>
									...
									<td vAlign="top">
										<table width="100%" align="center" border="0">
											...
											<tr>
												...
												<td><asp:textbox id="txt_partNoName" runat="server" Visible="False" text=""></asp:textbox></td>
											</tr>
											<tr>
											...
											<tr>
												...
												<td><asp:textbox id="txt_outCount" runat="server" Visible="False"></asp:textbox></td>
											</tr>
											<tr>
											...
											<tr>
												<td><asp:label id="lab_partOutInventoryId" runat="server" Text="" Visible="False"></asp:label></td>
											</tr>
											<TR>
											...
											<tr>
												<td colSpan="2"><asp:datagrid id="dg_PartOutInventoryDetail" runat="server" CellPadding="2" CellSpacing="2" AutoGenerateColumns="False"
														AllowPaging="True">
														...
														<Columns>
															...
															<asp:TemplateColumn HeaderText="partNoid">
																<HeaderTemplate>
																	<asp:Label id="dg_header_partNoid" runat="server">小編號</asp:Label>
																</HeaderTemplate>
																<ItemTemplate>
																	&nbsp;
															...
															<asp:TemplateColumn Visible="False" HeaderText="outCount">
																<HeaderTemplate>
