<%@ Page language="c#" Codebehind="MerchindiseSiteApprov.aspx.cs" AutoEventWireup="false" Inherits="ModuleWorkFlow.MerchindiseSiteApprov" %>
					...
					<tr>
						...
						<TD vAlign="top" width="79%">
							<table cellSpacing="2" width="100%" border="0">
								<tr>
									<td>
										<div align="left"><FONT face="新細明體">採購單核准設置</FONT></div>
									</td>
								</tr>
							</table>
							<hr>
