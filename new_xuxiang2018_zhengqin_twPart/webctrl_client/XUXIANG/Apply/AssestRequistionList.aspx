<%@ Page language="c#" Codebehind="AssestRequistionList.aspx.cs" AutoEventWireup="false" Inherits="ModuleWorkFlow.AssestRequistionList" %>
<%@ Register TagPrefix="uc1" TagName="AssestRequistionHeader" Src="controls/AssestRequistionHeader.ascx" %>
												...
												<td colSpan="2">
													<asp:datagrid id="dg_AssestRequistion" runat="server" AutoGenerateColumns="False" CellSpacing="2"
														...
														<Columns>
															...
															<asp:TemplateColumn>
																<ItemTemplate>
																	<asp:HyperLink id=HyperLink_Edit runat="server" Text="編輯" NavigateUrl='<%# "AssestRequistionView.aspx?func=edit&id="+DataBinder.Eval(Container, "DataItem.Id") %>'>
																	</asp:HyperLink>
																</ItemTemplate>
															</asp:TemplateColumn>
