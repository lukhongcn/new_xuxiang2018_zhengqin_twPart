<%@ Page language="c#" Codebehind="MerchindiseSiteView.aspx.cs" AutoEventWireup="false" Inherits="ModuleWorkFlow.MerchindiseSiteView" %>
<%@ Register TagPrefix="uc1" TagName="header" Src="../controls/header.ascx" %>
<%@ Register TagPrefix="uc1" TagName="footer" Src="../controls/footer.ascx" %>
<%@ Register TagPrefix="uc1" TagName="LeftMenu" Src="../controls/LeftMenu.ascx" %>
<%@ Register TagPrefix="uc1" TagName="MerchindiseSiteHeader" Src="controls/MerchindiseSiteHeader.ascx" %>
			...
			<TABLE id="Table2" cellSpacing="0" cellPadding="0" width="100%" border="0">
				<TBODY>
					...
					<tr>
						...
						<TD width="1%">&nbsp;</TD>
						<TD vAlign="top" width="79%"><uc1:merchindisesiteheader id="MerchindiseSiteHeader" runat="server"></uc1:merchindisesiteheader><br>
							<hr>
									...
									<td vAlign="top">
										<table width="100%" align="center" border="0" DESIGNTIMEDRAGDROP="21">
											...
											<tr>
												...
												<td><asp:label id="lab_MerchindiseApplyId" runat="server" Text="請購單號"></asp:label></td>
											...
											<tr>
												<td><asp:label id="lab_approver" runat="server" Text="approver" Visible="False"></asp:label></td>
												<td><asp:textbox id="txt_approver" runat="server" Text="" Visible="False"></asp:textbox></td>
											</tr>
											<tr>
												...
												<TR>
													<TD vAlign="top">
														<TABLE width="100%" align="center" border="0">
															...
															<TR>
																<TD>
																	<asp:label id="lab_MerchindiseDetailPrice" runat="server" Text="未稅金額"></asp:label></TD>
																<TD>
															...
															<TR>
																...
																<TD>
																	<asp:label id="lab_isInventory" runat="server" Text="是否入庫" Visible=False></asp:label></TD>
																<TD>
																	<asp:checkbox id="chk_isInventory" runat="server" Visible=False></asp:checkbox></TD>
															...
															<TR>
																<TD>
																	<asp:label id="lab_loseRate" runat="server" Text="損耗率"></asp:label></TD>
																<TD>
																	<asp:textbox id="txt_loseRate" runat="server"></asp:textbox></TD>
																<TD>
																	<asp:label id="lab_inputPeriod" runat="server" Text="進貨週期"></asp:label></TD>
																<TD>
