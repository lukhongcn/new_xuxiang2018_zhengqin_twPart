...
<%@ Page language="c#" Codebehind="RejectDetailList.aspx.cs" AutoEventWireup="false" Inherits="ModuleWorkFlow.RejectDetailList" %>
									...
									<td vAlign="top">
										<table width="100%" align="center" border="0">
											...
											<tr>
												...
												<td><asp:textbox id="txt_RejectDetailNo" runat="server"></asp:textbox></td>
											</tr>
											<tr>
											...
											<tr>
												<td><asp:label id="lab_assestNuit" runat="server" Text="單位"></asp:label></td>
												<td><asp:dropdownlist id="dpl_assestNuit" runat="server"></asp:dropdownlist></td>
											</tr>
											<tr>
											...
											<tr>
												<td><asp:label id="lab_checkAccount" runat="server" Text="進貨數量"></asp:label></td>
											...
											<tr>
												<td><asp:label id="lab_MerchindiseDetailId" runat="server" Visible="False" Text="MerchindiseDetailId"></asp:label></td>
												<td><asp:textbox id="txt_MerchindiseDetailId" runat="server" Visible="False"></asp:textbox></td>
											</tr>
											<tr>
												<td><asp:label id="lab_RejectId" runat="server" Visible="False" Text="RejectId"></asp:label><asp:label id="lab_MerchindiseCheckId" runat="server" Visible="False"></asp:label></td>
											...
											<tr>
												<td colSpan="2"><asp:datagrid id="dg_RejectDetail" runat="server" AutoGenerateColumns="False" CellSpacing="2"
														...
														<Columns>
															...
															<asp:TemplateColumn HeaderText="assestComment" Visible="False">
																<HeaderTemplate>
															...
															<asp:TemplateColumn HeaderText="MerchindiseDetailId" Visible="False">
																<HeaderTemplate>
															...
															<asp:TemplateColumn HeaderText="RejectId" Visible="False">
																<HeaderTemplate>
