...
<%@ Page language="c#" Codebehind="RejectList.aspx.cs" AutoEventWireup="false" Inherits="ModuleWorkFlow.RejectList" %>
												...
												<td colSpan="2">
													<asp:datagrid id="dg_Reject" runat="server" AutoGenerateColumns="False" CellSpacing="2" CellPadding="2">
														...
														<Columns>
															...
															<asp:TemplateColumn>
																<ItemTemplate>
																	<asp:HyperLink id=HyperLink_Edit runat="server" Text="編輯" NavigateUrl='<%# "RejectView.aspx?func=edit&id="+DataBinder.Eval(Container, "DataItem.Id") %>'>
																	</asp:HyperLink>
																</ItemTemplate>
															</asp:TemplateColumn>
