...
<%@ Page language="c#" Codebehind="RejectTypeList.aspx.cs" AutoEventWireup="false" Inherits="ModuleWorkFlow.RejectTypeList" %>
								...
								<tr>
									<td vAlign="top">
										<table width="100%" align="center" border="0">
											...
											<tr>
												<td><asp:Label ID="lab_name" runat="server" Text="name">名稱</asp:Label></td>
											...
											<tr>
												<td colSpan="2">
													<asp:datagrid id="dg_RejectType" runat="server" AutoGenerateColumns="False" CellSpacing="2" CellPadding="2">
