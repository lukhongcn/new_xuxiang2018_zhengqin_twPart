<%@ Register TagPrefix="uc1" TagName="CUTHeader" Src="controls/CUTHeader.ascx" %>
<%@ Register TagPrefix="uc1" TagName="LeftMenu" Src="controls/LeftMenu.ascx" %>
<%@ Register TagPrefix="uc1" TagName="Header" Src="controls/Header.ascx" %>
<%@ Register TagPrefix="uc1" TagName="Footer" Src="controls/Footer.ascx" %>
<%@ Page language="c#" Codebehind="CUTMachineAddEdit.aspx.cs" AutoEventWireup="false" Inherits="ModuleWorkFlow.admin.CUTMachineAddEdit" %>
				...
				<TBODY>
					...
					<TR>
						...
						<TD vAlign="top" width="79%">
							<uc1:CUTHeader id="CUTHeader" runat="server"></uc1:CUTHeader><br>
