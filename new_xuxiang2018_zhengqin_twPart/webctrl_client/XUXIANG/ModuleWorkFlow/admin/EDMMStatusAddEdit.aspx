<%@ Page language="c#" Codebehind="EDMMStatusAddEdit.aspx.cs" AutoEventWireup="false" Inherits="ModuleWorkFlow.admin.EDMMStatusAddEdit" %>
<%@ Register TagPrefix="uc1" TagName="EDMStatusHeader" Src="controls/EDMStatusHeader.ascx" %>
				...
				<TBODY>
					...
					<TR>
						...
						<TD vAlign="top" width="79%">
							<uc1:EDMStatusHeader id="EDMStatusHeader" runat="server"></uc1:EDMStatusHeader><br>
