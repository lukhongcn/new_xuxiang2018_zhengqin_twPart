						...
						<TD vAlign="top" width="79%"><uc1:machineheader id="MachineHeader" runat="server"></uc1:machineheader><br>
							<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="1">
								<TBODY>
									...
									<TR>
										<TD width="20%">³Z¡¼Úñ¸¡</TD>
										<TD width="80%"><asp:textbox id="Textbox_MachineId" name="Textbox_MachineId" Runat="server"></asp:textbox><asp:requiredfieldvalidator id="RequiredFieldValidator1" runat="server" ControlToValidate="Textbox_MachineId"
												ErrorMessage="¥s¶ô¡¼³Z¡¼Úñ¸¡"></asp:requiredfieldvalidator></TD>
									</TR>
									<TR>
										<TD width="20%">ê¦òv</TD>
