					...
					<TR>
						...
						<TD vAlign="top" width="79%">
							...
							<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="1">
								<TBODY>
									<tr>
										<td colSpan="2"><B>¥s´c¡¼¡¼¡¼Ã¡¡¼</B></td>
									</tr>
									<TR>
										<TD width="20%">¡¼¡¼Úñ¸¡</TD>
										<TD width="80%"><asp:TextBox Runat="server" ID="txb_UserName" Enabled=False /></TD>
									</TR>
									<TR>
										<TD>¡¼¡¼¡¼¸¡</TD>
									...
									<TR>
										<TD>&nbsp;</TD>
										<TD><asp:button id="Button_Edit" runat="server" Text="÷ç¡¼¡¼¡¼"></asp:button></TD>
									</TR>
								</TBODY>
							</TABLE>
							<br>
