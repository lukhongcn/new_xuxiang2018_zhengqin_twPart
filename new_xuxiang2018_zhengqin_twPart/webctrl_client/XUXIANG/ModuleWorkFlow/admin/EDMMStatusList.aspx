...
<%@ Page language="c#" Codebehind="EDMMStatusList.aspx.cs" AutoEventWireup="false" Inherits="ModuleWorkFlow.admin.EDMMStatusList" %>
					...
					<TR>
						...
						<TD vAlign="top" width="79%">
							...
							<table id="TableCondition" cellSpacing="0" cellPadding="0" width="100%" border="0">
								<TR>
									<TD>¦J©Ú¡¼¡¼<asp:dropdownlist id="DropDownList_Process" Runat="server" AutoPostBack="True"></asp:dropdownlist></TD>
								</TR>
							</table>
							<asp:datagrid id="MainDataGrid" runat="server" AutoGenerateColumns="False" Width="100%" CellSpacing="2"
								...
								<Columns>
									<asp:BoundColumn DataField="EDMID" HeaderText="³Z¡¼Úñ¸¡"></asp:BoundColumn>
									...
									<asp:TemplateColumn HeaderText="¡¼¡¼">
										<ItemTemplate>
											<asp:HyperLink id=HyperLink_Edit runat="server" Text="Úñ¯ã" NavigateUrl='<%# "EDMMStatusAddEdit.aspx?func=edit&machineid="+DataBinder.Eval(Container, "DataItem.edmid")+"&partno="+DataBinder.Eval(Container, "DataItem.partno")+"&partno_id="+DataBinder.Eval(Container, "DataItem.partno_id")+"&moduleid="+DataBinder.Eval(Container, "DataItem.moduleid")+"&processdate="+string.Format("{0:yyyy-MM-dd}",DataBinder.Eval(Container, "DataItem.processdate"))%>'>
											</asp:HyperLink>
										</ItemTemplate>
									</asp:TemplateColumn>
