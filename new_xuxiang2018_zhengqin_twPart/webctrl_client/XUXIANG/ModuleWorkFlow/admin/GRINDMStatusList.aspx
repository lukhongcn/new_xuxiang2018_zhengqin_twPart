<%@ Page language="c#" Codebehind="GRINDMStatusList.aspx.cs" AutoEventWireup="false" Inherits="ModuleWorkFlow.admin.GRINDMStatusList" %>
					...
					<TR>
						...
						<TD vAlign="top" width="79%">
							...
							<asp:datagrid id="MainDataGrid" runat="server" AutoGenerateColumns="False" Width="100%" CellSpacing="2"
								...
								<Columns>
									<asp:BoundColumn DataField="GRINDID" HeaderText="³Z¡¼Úñ¸¡"></asp:BoundColumn>
									...
									<asp:TemplateColumn HeaderText="¡¼¡¼">
										<ItemTemplate>
											<asp:HyperLink id=HyperLink_Edit runat="server" Text="Úñ¯ã" NavigateUrl='<%# "GRINDMStatusAddEdit.aspx?func=edit&machineid="+DataBinder.Eval(Container, "DataItem.grindid")+"&partno="+DataBinder.Eval(Container, "DataItem.partno")+"&partno_id="+DataBinder.Eval(Container, "DataItem.partno_id")+"&moduleid="+DataBinder.Eval(Container, "DataItem.moduleid")+"&processdate="+string.Format("{0:yyyy-MM-dd}",DataBinder.Eval(Container, "DataItem.processdate"))%>'>
											</asp:HyperLink>
										</ItemTemplate>
									</asp:TemplateColumn>
