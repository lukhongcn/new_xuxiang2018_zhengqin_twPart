...
<%@ Page language="c#" Codebehind="EDMMachineAddEdit.aspx.cs" AutoEventWireup="false" Inherits="ModuleWorkFlow.admin.EDMMachineAddEdit" %>
<%@ Register TagPrefix="uc1" TagName="EDMHeader" Src="controls/EDMHeader.ascx" %>
				...
				<TBODY>
					...
					<TR>
						...
						<TD vAlign="top" width="79%">
							<uc1:EDMHeader id="EDMHeader" runat="server"></uc1:EDMHeader><br>
