								...
								<TBODY>
									...
									<TR>
										...
										<TD width="80%"><asp:TextBox Runat="server" ID="Textbox_DepartId" name="Textbox_DepartId" />
											<asp:RequiredFieldValidator id="RequiredFieldValidator1" runat="server" ErrorMessage="¥s¶ô¡¼³õ¡¼Úñ¸¡" ControlToValidate="Textbox_DepartId"></asp:RequiredFieldValidator>
										</TD>
									</TR>
									<TR>
										<TD width="20%">³õ¡¼¡¼¼K</TD>
										<TD width="80%"><asp:TextBox Runat="server" ID="Textbox_DepartName" name="Textbox_DepartName" />
											<asp:RequiredFieldValidator id="Requiredfieldvalidator2" runat="server" ErrorMessage="¥s¶ô¡¼³õ¡¼¡¼¼K" ControlToValidate="Textbox_DepartName"></asp:RequiredFieldValidator>
										</TD>
									</TR>
									<TR>
										<TD>&nbsp;</TD>
