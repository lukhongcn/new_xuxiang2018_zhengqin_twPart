<%@ Page language="c#" Codebehind="MILLINGMStatusAddEdit.aspx.cs" AutoEventWireup="false" Inherits="ModuleWorkFlow.admin.MILLINGMStatusAddEdit" %>
				...
				<TBODY>
					...
					<TR>
						...
						<TD vAlign="top" width="79%">
							<uc1:MILLINGMStatusHeader id="MILLINGMStatusHeader" runat="server"></uc1:MILLINGMStatusHeader><br>
									...
									<TR>
										...
										<TD width="80%">
											...
											<asp:RequiredFieldValidator id="RequiredFieldValidator3" runat="server" ControlToValidate="Textbox_PartNo_Id"
												ErrorMessage="¥s¶ô¡¼ã]¡¼Úñ¸¡-ID"></asp:RequiredFieldValidator></TD>
									</TR>
									<TR>
										<TD width="20%">¡¼ÂW</TD>
										<TD width="80%">
