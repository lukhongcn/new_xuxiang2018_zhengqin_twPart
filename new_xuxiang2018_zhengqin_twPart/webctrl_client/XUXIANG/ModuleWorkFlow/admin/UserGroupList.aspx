						...
						<TD vAlign="top" width="79%"><uc1:usergroupheader id="UserGroupHeader" runat="server"></uc1:usergroupheader><BR>
							<asp:datagrid id="MainDataGrid" runat="server" AutoGenerateColumns="False" Width="100%" CellSpacing="2"
								...
								<Columns>
									...
									<asp:BoundColumn DataField="name" HeaderText="ÚÝ¿µ¡¼¼K"></asp:BoundColumn>
									<asp:BoundColumn DataField="usercount" HeaderText="ÚÝ¿µ¡¼¡¼­pÏü"></asp:BoundColumn>
									<asp:TemplateColumn HeaderText="¡¼¡¼">
										<ItemTemplate>
											<asp:HyperLink id=HyperLink_Edit runat="server" Text="Úñ¯ã" NavigateUrl='<%# "UserGroupAddEdit.aspx?func=edit&id="+DataBinder.Eval(Container, "DataItem.id") %>'>
											</asp:HyperLink>
										</ItemTemplate>
									</asp:TemplateColumn>
