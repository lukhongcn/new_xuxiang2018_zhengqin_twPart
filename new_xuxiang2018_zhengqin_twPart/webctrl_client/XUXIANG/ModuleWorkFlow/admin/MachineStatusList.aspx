					...
					<TR>
						...
						<TD vAlign="top" width="79%"><uc1:machinestatusheader id="MachineStatusHeader" runat="server"></uc1:machinestatusheader><BR>
							<table id="TableCondition" cellSpacing="0" cellPadding="0" width="100%" border="0">
								<TBODY>
									<TR>
										<TD width="15%">¡¼¡¼<asp:dropdownlist id="DropDownList_Process" AutoPostBack="True" Runat="server"></asp:dropdownlist></TD>
										<TD width="15%">®a£´<asp:dropdownlist id="DropDownList_ModuleId" AutoPostBack="True" Runat="server"></asp:dropdownlist></TD>
										<TD width="26%">¬g¡È¡¼ÂW<asp:textbox id="Textbox_StartDate" Runat="server"></asp:textbox>
											<asp:linkbutton id="LinkButton_StartDate" runat="server">¦J©Ú</asp:linkbutton><asp:calendar id="Calendar_StartDate" runat="server" Visible="False"></asp:calendar></TD>
										<TD width="26%">¾×¡¼¡¼ÂW<asp:textbox id="Textbox_EndDate" Runat="server"></asp:textbox>
											<asp:linkbutton id="LinkButton_EndDate" runat="server">¦J©Ú</asp:linkbutton><asp:calendar id="Calendar_EndDate" runat="server" Visible="False"></asp:calendar></TD>
										<TD width="8%"><asp:button id="Button_Search" Runat="server" Text="Ú¨°ª"></asp:button></TD>
									</TR>
								</TBODY>
							</table>
