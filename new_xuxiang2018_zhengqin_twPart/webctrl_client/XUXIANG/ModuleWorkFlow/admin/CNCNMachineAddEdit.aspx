<%@ Register TagPrefix="uc1" TagName="CNCNHeader" Src="controls/CNCNHeader.ascx" %>
<%@ Register TagPrefix="uc1" TagName="LeftMenu" Src="controls/LeftMenu.ascx" %>
<%@ Register TagPrefix="uc1" TagName="Header" Src="controls/Header.ascx" %>
<%@ Register TagPrefix="uc1" TagName="Footer" Src="controls/Footer.ascx" %>
<%@ Page language="c#" Codebehind="CNCNMachineAddEdit.aspx.cs" AutoEventWireup="false" Inherits="ModuleWorkFlow.admin.CNCNMachineAddEdit" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>CNCª¤Þï³Z¡¼¡~</title>
				...
				<TBODY>
					...
					<TR>
						...
						<TD vAlign="top" width="79%">
							<uc1:CNCNHeader id="CNCNHeader" runat="server"></uc1:CNCNHeader><br>
								...
								<TBODY>
									...
									<TR>
										...
										<TD width="80%"><asp:TextBox Runat="server" ID="Textbox_MachineId" name="Textbox_MachineId" />
											<asp:RequiredFieldValidator id="RequiredFieldValidator1" runat="server" ErrorMessage="¥s¶ô¡¼³Z¡¼Úñ¸¡" ControlToValidate="Textbox_MachineId"></asp:RequiredFieldValidator>
										</TD>
									</TR>
									<TR>
										<TD width="20%">ê¦òv</TD>
									...
									<TR>
										...
										<TD width="80%">
											<asp:DropDownList id="Dropdownlist_Priority" runat="server">
												...
												<asp:ListItem Value="2">02</asp:ListItem>
												<asp:ListItem Value="1">01</asp:ListItem>
											</asp:DropDownList><font color="red">(µ{Ä§Å×¡¼¡¼¡¼01,µ{¡¼Å×¡¼¡¼¡¼20)</font>
										</TD>
									</TR>
									<TR>
										<TD>&nbsp;</TD>
