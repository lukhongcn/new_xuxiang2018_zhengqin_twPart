					...
					<TR>
						...
						<TD vAlign="top" width="79%">
							...
							<asp:datagrid id="MainDataGrid" runat="server" AutoGenerateColumns="False" Width="100%" CellSpacing="2"
								...
								<Columns>
									<asp:BoundColumn DataField="DepartmentId" HeaderText="³õ¡¼Úñ¸¡"></asp:BoundColumn>
									<asp:BoundColumn DataField="DepartmentName" HeaderText="³õ¡¼¡¼¼K"></asp:BoundColumn>
									<asp:TemplateColumn HeaderText="¡¼¡¼">
										<ItemTemplate>
											<asp:HyperLink id=HyperLink_Edit runat="server" Text="Úñ¯ã" NavigateUrl='<%# "DepartAddEdit.aspx?func=edit&departid="+DataBinder.Eval(Container, "DataItem.departmentid") %>'>
											</asp:HyperLink>
										</ItemTemplate>
									</asp:TemplateColumn>
								</Columns>
