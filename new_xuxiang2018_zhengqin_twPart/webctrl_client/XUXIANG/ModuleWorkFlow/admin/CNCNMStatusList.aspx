...
<%@ Register TagPrefix="uc1" TagName="CNCNStatusHeader" Src="controls/CNCNStatusHeader.ascx" %>
<%@ Page language="c#" Codebehind="CNCNMStatusList.aspx.cs" AutoEventWireup="false" Inherits="ModuleWorkFlow.admin.CNCNMStatusList" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>CNCª¤Þï³Z¡¼ß±¡¼¡~</title>
				...
				<TBODY>
					...
					<TR>
						...
						<TD vAlign="top" width="79%">
							<uc1:CNCNStatusHeader id="CNCNStatusHeader" runat="server"></uc1:CNCNStatusHeader><BR>
							<asp:datagrid id="MainDataGrid" runat="server" AutoGenerateColumns="False" Width="100%" CellSpacing="2"
								...
								<Columns>
									<asp:BoundColumn DataField="CNCNID" HeaderText="³Z¡¼Úñ¸¡"></asp:BoundColumn>
									...
									<asp:TemplateColumn HeaderText="¡¼¡¼">
										<ItemTemplate>
											<asp:HyperLink id=HyperLink_Edit runat="server" Text="Úñ¯ã" NavigateUrl='<%# "CNCNMStatusAddEdit.aspx?func=edit&machineid="+DataBinder.Eval(Container, "DataItem.cncnid")+"&partno="+DataBinder.Eval(Container, "DataItem.partno")+"&partno_id="+DataBinder.Eval(Container, "DataItem.partno_id")+"&moduleid="+DataBinder.Eval(Container, "DataItem.moduleid")+"&processdate="+string.Format("{0:yyyy-MM-dd}",DataBinder.Eval(Container, "DataItem.processdate"))%>'>
											</asp:HyperLink>
										</ItemTemplate>
									</asp:TemplateColumn>
