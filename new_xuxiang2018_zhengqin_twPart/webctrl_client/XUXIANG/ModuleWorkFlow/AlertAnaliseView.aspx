							...
							<table id="Table_Header2" cellSpacing="0" cellPadding="0" width="100%" border="0">
								<tr>
									<td align="left" width="20%">
										<uc1:LeftMenu id="LeftMenu1" runat="server"></uc1:LeftMenu>¡¼¡~§L¡¼</td>
									<td align="left" width="1%">&nbsp;</td>
									<td valign="top">
										<table>
											<tr>
												<td>
													¡¼ÂW:<wc:inputcalendar id="tbx_Date" runat="server"></wc:inputcalendar>&nbsp;&nbsp;<asp:button id="Button_Search" Text="Ú¨°ª" Runat="server"></asp:button>
												</td>
											</tr>
											<tr>
												<td>
													<asp:DataGrid id="dgAnalise" runat="server" AutoGenerateColumns="False" Width="100%" CellSpacing="2"
														...
														<Columns>
															<asp:BoundColumn DataField="ProcessName" HeaderText="¡¼¡¼">
																<ItemStyle HorizontalAlign="Center"></ItemStyle>
															</asp:BoundColumn>
															<asp:BoundColumn DataField="ExtreAccount" HeaderText="ð@ÁÊ¡¼¡¼½S¡o"></asp:BoundColumn>
															<asp:BoundColumn DataField="NeedCount" HeaderText="ð@ÁÊ¡¼¡¼¡¼"></asp:BoundColumn>
															<asp:BoundColumn DataField="DelayDoneCount" HeaderText="¢{µ¨¡¼£K"></asp:BoundColumn>
														</Columns>
													</asp:DataGrid><br>
												</td>
											</tr>
