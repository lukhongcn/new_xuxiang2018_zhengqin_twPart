...
<%@ Page language="c#" Codebehind="milePartList.aspx.cs" AutoEventWireup="false" Inherits="ModuleWorkFlow.milePartList" %>
			...
			<TABLE id="Table2" cellSpacing="0" cellPadding="0" width="100%" border="0">
				<TBODY>
					...
					<TR>
						...
						<TD width="1%">&nbsp;</TD>
						<TD vAlign="top"><uc1:milepartheader id="milePartHeader" runat="server"></uc1:milepartheader><BR>
							...
							<asp:label id="lab_print" Text="打印條碼選擇" Runat="server"></asp:label><asp:textbox id="txt_print" Runat="server"></asp:textbox><asp:label id="lab_show" Text="例如:1-10" Runat="server"></asp:label><asp:button id="btn_print" Text="打印條碼" Runat="server"></asp:button><asp:label id="lab_file" Runat="server"></asp:label><asp:button id="btn_delete" runat="server" Text="刪除"></asp:button><FONT face="新細明體"></FONT><asp:label id="lab_pagecount" Runat="server" Visible="False"></asp:label><asp:label id="lab_search" Runat="server" Visible="False"></asp:label><asp:datagrid id="MainDataGrid" runat="server" Width="100%" AllowPaging="True" AutoGenerateColumns="False"
								...
								<Columns>
									...
									<asp:TemplateColumn>
										<ItemTemplate>
											<asp:HyperLink id=HyperLink_EditOthers runat="server" Text="基本信息編輯" NavigateUrl='<%# "milePartEditOthers.aspx?moduleid="+DataBinder.Eval(Container, "DataItem.moduleid")+"&partno="+DataBinder.Eval(Container, "DataItem.PartNo")+"&search="+lab_search.Text+"&pagecount="+MainDataGrid.CurrentPageIndex.ToString() %>'>
											</asp:HyperLink>
										</ItemTemplate>
									</asp:TemplateColumn>
