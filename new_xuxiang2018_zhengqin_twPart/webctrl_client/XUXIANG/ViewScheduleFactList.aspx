<%@ Page language="c#" Codebehind="ViewScheduleFactList.aspx.cs" AutoEventWireup="false" Inherits="ModuleWorkFlow.ViewScheduleFactList" %>
<%@ Register TagPrefix="uc1" TagName="MidView" Src="controls/MidViewFact.ascx" %>
<%@ Register TagPrefix="uc1" TagName="SmallView" Src="controls/SmallViewFact.ascx" %>
						...
						<TD vAlign="top" width="79%">
							<table id="Table_Header2" cellSpacing="0" cellPadding="0" width="100%" border="1">
								<tr>
									...
									<td><asp:button id="btn_acction" Runat="server" Text="系統排程提交"></asp:button></td>
								</tr>
							</table>
							<BR>
							<asp:datagrid id="MainDataGrid" runat="server" Width="100%" CellPadding="2" CellSpacing="2" AutoGenerateColumns="False"
								...
								<Columns>
									...
									<asp:ButtonColumn Text="排程信息" HeaderText="功能" CommandName="Select"></asp:ButtonColumn>
								</Columns>
							...
							<uc1:midview id="MidViewFact" runat="server"></uc1:midview><uc1:smallview id="SmallViewFact" runat="server"></uc1:smallview><br>
