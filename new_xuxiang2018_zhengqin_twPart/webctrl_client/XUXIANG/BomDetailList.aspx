...
<%@ Page language="c#" Codebehind="BomDetailList.aspx.cs" AutoEventWireup="false" Inherits="ModuleWorkFlow.BomDetailList" %>
			...
			<TABLE id="Table2" cellSpacing="0" cellPadding="0" width="100%" border="0">
				<TBODY>
					...
					<tr>
						...
						<TD width="1%">&nbsp;</TD>
						<TD vAlign="top" width="79%"><uc1:bomdetailheader id="BomDetailHeader" runat="server"></uc1:bomdetailheader>
												...
												<td colSpan="2"><asp:datagrid id="dg_BomDetail" runat="server" CellPadding="2" CellSpacing="2" AutoGenerateColumns="False"
														...
														<Columns>
															...
															<asp:TemplateColumn HeaderText="productNo">
																<HeaderTemplate>
																	<asp:Label id="dg_haeder_productNo" runat="server" text="工令單號"></asp:Label>
																</HeaderTemplate>
																<ItemTemplate>
																	&nbsp;
															...
															<asp:TemplateColumn>
																<ItemTemplate>
																	&nbsp;
																	<asp:HyperLink id=HyperLink_bom runat="server" Text="BOM詳細明細編輯" NavigateUrl='<%# "BomDetailView.aspx?func=edit&id="+DataBinder.Eval(Container, "DataItem.Id") %>'>
																	</asp:HyperLink>
																</ItemTemplate>
															</asp:TemplateColumn>
															<asp:TemplateColumn>
																<ItemTemplate>
																	&nbsp;
																	<asp:HyperLink ID="HyperLink_Eitd" runat="server" text="BOM編輯" NavigateUrl='<%# "BomDetailViewExcel.aspx?func=edit&id="+DataBinder.Eval(Container, "DataItem.Id") %>'>
																	</asp:HyperLink>
																</ItemTemplate>
															</asp:TemplateColumn>
