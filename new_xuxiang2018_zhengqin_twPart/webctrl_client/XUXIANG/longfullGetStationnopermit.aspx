...
<%@ Page language="c#" Codebehind="longfullGetStationnopermit.aspx.cs" AutoEventWireup="false" Inherits="ModuleWorkFlow.longfullGetStationnopermit" %>
						...
						<TD vAlign="top" width="79%">
							...
							<table width="100%" align="center" border="0">
								...
								<tr>
									...
									<td><asp:label id="lab_user_value" runat="server"></asp:label>
										<asp:Label ID="lab_username" Runat="server" Visible="false"></asp:Label></td>
									...
									<TD colspan="2">
										<TABLE id="Table4" borderColor="#000660" borderColorDark="#000066" width="100%" align="center"
											...
											<TR vAlign="middle">
												...
												<TD class="msg" width="85%">&nbsp;&nbsp;
													<asp:label id="lab_status" Runat="server" CssClass="content" ForeColor="Red"></asp:label></TD>
											</TR>
										</TABLE>
									</TD>
								</TR>
