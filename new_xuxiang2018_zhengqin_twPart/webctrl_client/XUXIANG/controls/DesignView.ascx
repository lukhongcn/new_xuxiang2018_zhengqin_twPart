<%@ Control Language="c#" AutoEventWireup="false" Codebehind="DesignView.ascx.cs" Inherits="ModuleWorkFlow.controls.DesignView" TargetSchema="http://schemas.microsoft.com/intellisense/ie5"%>
