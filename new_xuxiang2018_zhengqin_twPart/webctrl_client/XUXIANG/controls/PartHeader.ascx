...
<table width="100%" border="0" cellspacing="2">
  <tr>
    ...
    <td>
      <div align="right"> 
        <a href="milePartList.aspx?customerid=<%=customerid%>&moduleid=<%=moduleid%>">[ 顯示全部資料 ]</a>
        &nbsp;<a href="milePartAddEdit.aspx?func=add&customerid=<%=customerid%>&moduleid=<%=moduleid%>">[ 添加資料 ]</a>
      </div>
    </td>
  </tr>
</table>
