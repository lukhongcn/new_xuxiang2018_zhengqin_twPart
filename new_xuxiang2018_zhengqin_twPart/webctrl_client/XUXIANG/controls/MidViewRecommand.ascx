<%@ Control Language="c#" AutoEventWireup="false" Codebehind="MidViewRecommand.ascx.cs" Inherits="ModuleWorkFlow.controls.MidViewRecommand" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
...
<asp:datagrid id="MainDatagrid" runat="server" CellPadding="2" CellSpacing="2" Width="100%" AutoGenerateColumns="False">
	...
	<Columns>
		...
		<asp:TemplateColumn HeaderText="processid">
			...
			<ItemTemplate>
				<asp:Label id="Label2" runat="server" Text='<%#DataBinder.Eval(Container, "DataItem.ProcessNeedMinutes")%>'/>
			</ItemTemplate>
		</asp:TemplateColumn>
