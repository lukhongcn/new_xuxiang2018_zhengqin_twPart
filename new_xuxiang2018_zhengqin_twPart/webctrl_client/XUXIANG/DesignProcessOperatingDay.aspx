<%@ Page language="c#" Codebehind="DesignProcessOperatingDay.aspx.cs" AutoEventWireup="false" Inherits="ModuleWorkFlow.DesignProcessOperatingDay" %>
				...
				<TBODY>
					...
					<TR>
						...
						<TD vAlign="top" width="79%">選擇工序<asp:dropdownlist id="Dropdownlist_Process" runat="server" AutoPostBack="True"></asp:dropdownlist>
							...
							</asp:dropdownlist>工令單號查詢：<asp:textbox id="txt_searchmodelid" runat="server" AutoPostBack="True"></asp:textbox>
							<asp:button id="bnt_submission" runat="server" Text="提 交"></asp:button><asp:datagrid id="MainDataGrid" runat="server" PageSize="15" AllowPaging="True" AutoGenerateColumns="False"
								...
								<Columns>
									...
									<asp:TemplateColumn HeaderText="工令單號">
										<ItemTemplate>
											&nbsp;
									...
									<asp:TemplateColumn HeaderText="暫停描述">
										<ItemTemplate>
											<asp:Button runat="server" ID="btn_comment" CommandName="comment" Text="添加描述"></asp:Button>
