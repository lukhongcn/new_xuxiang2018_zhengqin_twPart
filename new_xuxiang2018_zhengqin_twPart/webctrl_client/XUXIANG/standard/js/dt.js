...
//s_object¡¼íåÁñ¡¼¬ÑæÎ¡¼d_start-d_end£V¡¼¡¼¡¼¤B¶[·é¡¼´fðE¡¼¡¼¡¼¡¼¥_¡¼¡¼
...
cityareaname[0]=new Array('¡¼¡¼¶[','¡u¡¼¶[','¿c¡¼¶[','¡¼Úy¶[','ºï¿õ¶[','¡¼§g¶[','­Û¡¼¶[','¡¼¬K¡¼');
if (selectP=='02')
  { a=2;tempoption=new Option('æ½¡¼','æ½¡¼',false,true); }
else
  { tempoption=new Option('æ½¡¼','æ½¡¼'); }
eval('document.'+formname+'.'+preP+'.options[2]=tempoption;');
cityareacode[1]=new Array('0201','0202','0203','0204','0205','0206');
cityareaname[1]=new Array('¾`¥´','½Å¡¼','Íh¡¼','¬ñ¡¼','¸}¡¼','ÄñÏç');
if (selectP=='03')
...
cityareaname[2]=new Array('¸}¡¼','¡¼¡¼','Íh¡¼','¡¼¦c','ò²¡¼','Ây¡¼','¿c¡¼','¿¥¡¼','Ò£¡¼','¡¼ÂÇ','¡¼¡¼','ªk¡¼','íl¡¼','ª¤¡¼','×w¡¼','¿W¡¼','Ïa¡o','¡¼ÃÛ','¥j¡~','ÍhÃÛ');
if (selectP=='04')
...
cityareaname[3]=new Array('³U¡¼','¡¼¡¼','¡«¡¼¿±','Íh¢w','¡¼Äñ¡¼','¡¼¤o¡¼');
if (selectP=='05')
...
cityareaname[4]=new Array('¢Q¡¼','¡¼¡¼','¡¼¡u','¡¼¡¼','Íh¬g','¡¼Àï','«XÚw','ðcÚw','¡¼»A','¡¼ß{','¡uÂy','¡¼Íh','¡¼¡¼','Úy¬P','ÅJ¡¼');
if (selectP=='06')
  { a=6;tempoption=new Option('¬ù¡¼','¬ù¡¼',false,true); }
else
  { tempoption=new Option('¬ù¡¼','¬ù¡¼'); }
...
cityareaname[5]=new Array('¬ù¡¼','Ö¢¡¼','¡¼¡¼','¡W¡¼','¡¼©î','¬PÀô','ô¦¯¾','¿õ¡¼','¹F¡¼','Â©»Ô','æÈ¡¼','¡¼¤è','£]¡¼','£]ò³','»«¡¼');
if (selectP=='07')
...
cityareaname[6]=new Array('¡¼²£Äñ','¡¼¡¼','¡¼¡¼¯d','¾m÷n','¡¼¡¼','¡¼²£¡¼','¢sÐK','³ö¡¼','­¸¡¼','÷ç¡~','Áû¡¼');
if (selectP=='08')
...
cityareaname[7]=new Array('¡¼¡¼','¡¼¡¼','¿õÞ±','¡¼¡¼','¡¼Þ®','æòùï','¡¼¡¼');
if (selectP=='09')
  { a=9;tempoption=new Option('¡¼öû¡¼','¡¼öû¡¼',false,true); }
else
  { tempoption=new Option('¡¼öû¡¼','09'); }
...
cityareaname[8]=new Array('¡À¢Q¡¼¡¼','¡¼ò³','¡¼¡¼','æò¡¼','¡¼¯¯','´É¦c','«¶Ò§¡¼¡¼','Þï¨g','¡¼¡¼','¡¼¢s²k','¡¼Ä^¡¼¡¼');
if (selectP=='10')
...
cityareaname[9]=new Array('¡¼¿õ','¡¼Ö³','ºï¡¼','ðs¡¼','¡¼¡¼','²Íðs','Å¦©Ô','©u§Ý','²p¡¼','¨g¿õ','¡¼¡¼','¡¼­ê','ºï¿õ','²ã²ö¯d');
if (selectP=='11')
  { a=11;tempoption=new Option('¡¼Ò§','¡¼Ò§',false,true); }
else
  { tempoption=new Option('¡¼Ò§','¡¼Ò§'); }
eval('document.'+formname+'.'+preP+'.options[11]=tempoption;');
cityareacode[10]=new Array('1101','1102','1103','1104','1105','1106','1107','1108','1109');
cityareaname[10]=new Array('¡¼Ön','¡¼Ò§','¡¼¡¼','¨g¤è','Þï¡¼','¡¼¡¼','Ò£¡¼','¡¼¡¼','¢{®Y');
if (selectP=='12')
  { a=12;tempoption=new Option('°ôÄñ¡¼','°ôÄñ¡¼',false,true); }
else
  { tempoption=new Option('°ôÄñ¡¼','°ôÄñ¡¼'); }
...
cityareaname[11]=new Array('¡¼²kÅJ','ÀNÀN¡¼²k','ùà¡¼¡¼','£}¡¼§j','¡¼¯¾','¡¼Ön','°ô¡¼','½¯¡u','¡¼Ïç','ÆZõì¡¼','¡¼¡¼¡¼','¡¼¡¼','¡¼¬å¡¼©Ô');
if (selectP=='13')
  { a=13;tempoption=new Option('¡¼Àq','¡¼Àq',false,true); }
else
  { tempoption=new Option('¡¼Àq','¡¼Àq'); }
...
cityareaname[12]=new Array('Íh£y','Àq¡¼','ìÍ«¶','¡¼¡¼','°¨¡¼','Ö³­á»A ','³Ý¡¼','¡¼¡¼ ','ÍhÞï','¬ñ¡¼','¥Ø¼é','¡¼¡¼','Þ×½x');
if (selectP=='14')
...
cityareaname[13]=new Array('¡¼¡¼','¥´¡¼','ß{¡¼','©ñ¡¼','´Ý¬å','¡_¡¼','¥j¬å','¡¼¦a','¡¼¡¼','¼A¡¼','¦cÚs');
if (selectP=='15')
...
cityareaname[14]=new Array('¡¼¡¼  ','¯N¥´ ','¡¼±õ ','ôÛ¡¼ ','¡¼¯¾ ','¡¼¡¼ ','¿W¡¼ ','¡¼¡¼ ','¥ØÍh ','Þ×¡¼ ','½Jºï¡¼ ','Â®¶r','¥Ø¡¼ ','¡¼¿õ ','¡¼¡¼ ','Ïæ¥´ ','¡¼¡¼');
if (selectP=='16')
  { a=16;tempoption=new Option('½Å¡¼','½Å¡¼',false,true); }
else
  { tempoption=new Option('½Å¡¼','½Å¡¼'); }
eval('document.'+formname+'.'+preP+'.options[16]=tempoption;');
cityareacode[15]=new Array('1601','1602','1603','1604','1605','1606','1607','1608','1609');
cityareaname[15]=new Array('½Å¡¼ ','ãH¡¼ ','Þ±¡¼ ','íÎ¡¼ ','Äñ¬£ ','Íh¡¼ ','¦cÐK ','¡¼¡¼ ','¡¼¡¼');
if (selectP=='17')
...
cityareaname[16]=new Array('Íh¡¼','¬KÐK°¨','¡¼¡¼','º°Ïû','¡¼¡¼','Ë{­Ý','÷ï¡¼','¡¢Ön','¡¼¡¼','¡¼¨º','©u¡¼');
if (selectP=='18')
...
cityareaname[17]=new Array('Á¢Íh','Ây¯d','ê}Ã¨','ÐK¡¼','¼o¡¼','Íù¡¼','Á¢¦c','¡¼¡¼','æòùü','¸}êÕ','¡¼¡¼','ÃãÄñ','¡¼×ô','§Ì¯N','¥U¡¼','ÅJ¡¼','¡¼²p');
if (selectP=='19')
  { a=19;tempoption=new Option('¡¼Íh','¡¼Íh',false,true); }
else
  { tempoption=new Option('¡¼Íh','¡¼Íh'); }
...
cityareaname[18]=new Array('ºñ¡¼','¬g¡¼','¡¼¿õ','¡¼×ë¡¼','¡¼¿õ','¡¼ªÈ','¡¼Ïû','¡¼¡¼','§N¿õ','¶x¡¼','ÍÕ¡¼','¡¼¡¼ª¶','Íh¿õ','Åò¡¼','¢W¡¼','ãy½J¢z','Ã¡¿õ','Á¢¤è');
if (selectP=='20')
...
cityareaname[19]=new Array('Úyðc','¿W¡¼','¡¼Ão','¡¼¡¼','¡¢¡¼','Â³²ó','¬î¡¼','¡¼¡¼','¡¼ãF','¿W¡¼','ÏÒ¦c','¡¼Öo','Áf¡¼','¡¼¡¼','¡¼¡¼','ªÓ¡¼','¡¼ÖÏëä');
if (selectP=='21')
  { a=21;tempoption=new Option('¥´Íh','21',false,true); }
else
  { tempoption=new Option('¥´Íh','¥´Íh'); }
...
cityareaname[20]=new Array('¡¼¡«','¡¼¡¼','µª­Ý','Áû¿õ','¡¼¿õ','¡K¿õ','¡¼ÐK','Ä¡¡¼','·ò¿õ','¡¼¡¼','ÛI¡¼','­c¢z','µª¡u ');
if (selectP=='22')
  { a=22;tempoption=new Option('¬ù¡u','¬ù¡u',false,true); }
else
  { tempoption=new Option('¬ù¡u','¬ù¡u'); }
...
cityareaname[21]=new Array('Íh¦c','Ú¤¡¼','¡¼Ò§','åx¡¼','¡¼¡¼','¡¼¡¼»A','Â«¡¼','°ò»A','¡¼Ò§','ê®¡¼','£e¡g','¡¼¡¼');
if (selectP=='23')
  { a=23;tempoption=new Option('¡¼Íh','¡¼Íh',false,true); }
else
  { tempoption=new Option('¡¼Íh','¡¼Íh'); }
eval('document.'+formname+'.'+preP+'.options[23]=tempoption;');
cityareacode[22]=new Array('2301','2302','2303','2304','2305','2306','2307','2308','2309');
cityareaname[22]=new Array('¡¼¡¼ ','¡¼£w','Þï¡¼','¯í¡¼','¯í¡¼','¡¼¡¼','í·¦c','¡¼¡¼','º¨¡¼');
if (selectP=='24')
...
cityareaname[23]=new Array('£K±`','¡¼õß','¡¼¡¼¡¼','¦â¡¼','ÐK¿õ','³ý¿õ','¬ù¡¼','¥Ú¦c','¡¼¡¼','¸ë¡¼','Íh¡¼  ','¡¢·â','¬ù¡¼','­g¡¼','¡¼¡¼','À´¡¼','¡¼¡¼  ','¡¼¿± ','¡¼¡¼ ','¡¼¡¼ ');
if (selectP=='25')
  { a=25;tempoption=new Option('°ò¡¼','°ò¡¼',false,true); }
else
  { tempoption=new Option('°ò¡¼','°ò¡¼'); }
eval('document.'+formname+'.'+preP+'.options[25]=tempoption;');
cityareacode[24]=new Array('2501','2502','2503','2504','2505','2506','2507','2508','2509');
cityareaname[24]=new Array('°ò¿õ ','¡¼²Í¡¼','¼e¨Õ','Â®¡¼','¼·ÅÑ','¡¼§Ý','÷B¡uÍh ','÷B¡¼Íh','÷BÍh');
if (selectP=='26')
  { a=26;tempoption=new Option('­áÍh','­áÍh',false,true); }
else
  { tempoption=new Option('­áÍh','­áÍh'); }
...
cityareaname[25]=new Array('¡¼¡¼','¡¼¡¼','£TÛh','¡¼­ê','ÖqÞï','¡¼íf','æò­¸','÷ç¡¼','ß{¡¼','¡¼¡¼ ','¡¼¡¼ ','¡uÆZ¡¼¡¼ ','¶L°Ê ','¡¼í~ ','ÐK¡¼ ','¡¼¡¼','øK¯¾');
if (selectP=='27')
  { a=27;tempoption=new Option('¡u®È','27',false,true); }
else
  { tempoption=new Option('¡u®È','¡u®È'); }
eval('document.'+formname+'.'+preP+'.options[27]=tempoption;');
cityareacode[26]=new Array('2701','2702','2703','2704','2705','2706','2707');
cityareaname[26]=new Array('¢s¼i','¡¼£T','¡¼±`','¡¼Íh','¡¼¦Àªµ','¡¼¡¼','Ò§¡¼');
if (selectP=='28')
  { a=28;tempoption=new Option('ªü¡u','ªü¡u',false,true); }
else
  { tempoption=new Option('ªü¡u','ªü¡u'); }
...
cityareaname[27]=new Array('¡u¡¼','Â®¡¼','¸}½¯','ÏÒ¿õ','§bÍh','¢{¡¼','ðc¡¼','¼ÔÒ§','Åò¡¼','¡¼Ïá');
if (selectP=='29')
...
cityareaname[28]=new Array('Ä^¡¼','¡¼¡¼','¡¼½À','¡¼¡¼','¥j¡¼»Ô','¡~¡u','¡¼¡¼','¯¾¿õ','©úÍh','Úy¡¼','¡¼­I','ÒËÞ±','¡¼Íh ','æòâ×');
if (selectP=='30')
  { a=30;tempoption=new Option('Ây¡¼','Ây¡¼',false,true); }
else
  { tempoption=new Option('Ây¡¼','Ây¡¼'); }
eval('document.'+formname+'.'+preP+'.options[30]=tempoption;');
cityareacode[29]=new Array('3001','3002','3003','3004','3005','3006','3007','3008');
cityareaname[29]=new Array('¡u¦c','¡¼¡¼',' ¡¼¡¼ ','¿WÍh','¡¼Íh','ÏÄ¡¼','¡¼ÅÌ','¡¼¡u');
if (selectP=='31')
  { a=31;tempoption=new Option('¦câ×','¦câ×',false,true); }
else
  { tempoption=new Option('¦câ×','¦câ×'); }
eval('document.'+formname+'.'+preP+'.options[31]=tempoption;');
cityareacode[30]=new Array('3101','3102','3103','3104');
cityareaname[30]=new Array('½À¡¼','¡¼êÇ¡¼','½ÀÍh','¢O¡¼');
if (selectP=='32')
...
cityareaname[31]=new Array('¡¼æç¡¼ÀN','¡¼¢sÀz£{','¡¼¡¼¡¼','¡¼æçÆV','¡¼·ø','¢Q¡¼','¡¼¡¼Àq','¦À¡¼','¡¼¡¼¥¶Àq','¡¼¡¼¹Á¦|','¡¼¡¼','Ã¨²k®Z¢s','¡¼¼í');
if (selectP=='33')
...
if (selectP=='34')
  { a=34;tempoption=new Option('«å¡¼','«å¡¼',false,true); }
else
  { tempoption=new Option('«å¡¼','«å¡¼'); }
