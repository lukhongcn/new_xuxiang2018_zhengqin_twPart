<%@ Page language="c#" Codebehind="ProcessMachineReportView.aspx.cs" AutoEventWireup="false" Inherits="ModuleWorkFlow.ProcessMachineReportView" %>
					...
					<TR>
						...
						<TD vAlign="top" width="79%">
							<TABLE id="Table_Condition1" cellSpacing="0" cellPadding="0" width="100%" border="1" runat="server">
								...
								<tr>
									<td>選擇工序</td>
									<td><asp:dropdownlist id="DropDownList_ProcessId" Runat="server" AutoPostBack="True"></asp:dropdownlist></td>
								</tr>
								<tr>
									<td>開始日期</td>
