<%@ Register TagPrefix="uc1" TagName="PartDesign" Src="controls/xuxiangPartDesign.ascx" %>
<%@ Page language="c#" Codebehind="xuxiangPartDesignList.aspx.cs" AutoEventWireup="false" Inherits="ModuleWorkFlow.xuxiangPartDesignList" %>
				...
				<TBODY>
					...
					<TR>
						...
						<TD vAlign="top" width="79%"><uc1:partdesign id="partdesign" runat="server"></uc1:partdesign><BR>
							...
							<asp:textbox id="txt_moduleid" runat="server"></asp:textbox><asp:button id="btn_search" runat="server" Text="搜索"></asp:button>
							<asp:datagrid id="MainDataGrid" runat="server" CellPadding="2" CellSpacing="2" AutoGenerateColumns="False"
								...
								<Columns>
									<asp:BoundColumn DataField="ModuleId" HeaderText="工令單號" Visible="False"></asp:BoundColumn>
									...
									<asp:TemplateColumn HeaderText="動作">
										<ItemTemplate>
											<asp:HyperLink id="HyperLink_EditProcess" runat="server" Text="編輯" NavigateUrl='<%# "xuxiangPartDesignAddEdit.aspx?moduleid="+DataBinder.Eval(Container, "DataItem.moduleid")+"&partno="+Server.UrlEncode(DataBinder.Eval(Container, "DataItem.PartNo").ToString())+"&func=edit" %>'>
											</asp:HyperLink>
										</ItemTemplate>
									</asp:TemplateColumn>
