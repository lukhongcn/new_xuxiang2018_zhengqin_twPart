						...
						<TD vAlign="top" width="79%"><uc1:materialheader id="MaterialHeader" runat="server"></uc1:materialheader><BR>
							<asp:datagrid id="MainDataGrid" runat="server" AllowPaging="True" CellPadding="2" CellSpacing="2"
								...
								<Columns>
									...
									<asp:BoundColumn DataField="typeid" HeaderText="材質類型"></asp:BoundColumn>
									<asp:BoundColumn DataField="erpid" HeaderText="ERP編碼"></asp:BoundColumn>
									...
									<asp:TemplateColumn HeaderText="功能">
										<ItemTemplate>
											<asp:HyperLink id=HyperLink_Edit runat="server" Text="編輯" NavigateUrl='<%# "MaterialAddEdit.aspx?func=edit&id="+DataBinder.Eval(Container, "DataItem.id") %>'>
											</asp:HyperLink>
										</ItemTemplate>
									</asp:TemplateColumn>
