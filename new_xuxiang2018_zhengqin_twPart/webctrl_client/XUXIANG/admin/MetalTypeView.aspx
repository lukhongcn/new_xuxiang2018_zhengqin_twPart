					...
					<tr>
						...
						<TD vAlign="top" width="79%">
							<table cellSpacing="2" width="100%" border="0">
								<tr>
									<td>
										<div align="left">五金大類設定<asp:label id="Label_StatusMsg" runat="server"></asp:label></div>
									</td>
								</tr>
							</table>
							<hr>
							...
							<asp:datagrid id="MetalTypeDataGrid" runat="server" CellPadding="2" CellSpacing="2" AutoGenerateColumns="False">
								...
								<Columns>
									<asp:BoundColumn DataField="MetalTypeId" ReadOnly="True" HeaderText="大類編碼"></asp:BoundColumn>
									<asp:TemplateColumn HeaderText="大類名">
										<ItemTemplate>
