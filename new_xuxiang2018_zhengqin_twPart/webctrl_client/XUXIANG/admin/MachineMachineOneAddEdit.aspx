<%@ Page language="c#" Codebehind="MachineMachineOneAddEdit.aspx.cs" AutoEventWireup="false" Inherits="ModuleWorkFlow.admin.MachineMachineOneAddEdit" %>
					...
					<TR>
						...
						<TD vAlign="top" width="79%"><uc1:machineheader id="MachineHeader" runat="server"></uc1:machineheader><br>
							<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="1">
								<TBODY>
									<tr>
										<td colSpan="2" style="HEIGHT: 29px"><B>請填入以下信息</B>
									...
									<TR>
										<TD width="20%" style="HEIGHT: 36px">機台編號</TD>
										<TD width="80%" style="HEIGHT: 36px"><asp:textbox id="Textbox_MachineId" name="Textbox_MachineId" Runat="server"></asp:textbox><asp:requiredfieldvalidator id="RequiredFieldValidator1" runat="server" ControlToValidate="Textbox_MachineId"
												ErrorMessage="請輸入機台編號"></asp:requiredfieldvalidator>
											<asp:Label id="Label_Machine" runat="server" ForeColor="Red" Visible="False">請不要輸入帶有"-"的字符串</asp:Label></TD>
									</TR>
									<TR>
										<TD width="20%">描述</TD>
									...
									<TR>
										<TD width="20%" style="HEIGHT: 8px">選擇機台組</TD>
										<TD width="80%" style="HEIGHT: 8px"><asp:dropdownlist id="Dropdownlist_Group" runat="server"></asp:dropdownlist></TD>
									</TR>
									<TR>
										<TD width="20%" style="HEIGHT: 22px">每天有效工作時間</TD>
										<TD width="80%" style="HEIGHT: 22px">
											<asp:textbox id="DropDownList_HoursPerDay" Runat="server" name="Textbox_Description"></asp:textbox><FONT id="DropDownList_HoursPerDay" face="宋體">小時</FONT></TD>
									</TR>
									<TR>
										<TD width="20%">優先級</TD>
