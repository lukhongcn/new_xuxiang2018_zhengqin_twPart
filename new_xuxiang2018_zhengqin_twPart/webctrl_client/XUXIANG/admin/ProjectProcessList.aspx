...
<%@ Page language="c#" Codebehind="ProjectProcessList.aspx.cs" AutoEventWireup="false" Inherits="ModuleWorkFlow.ProjectProcessList" %>
								...
								<tr>
									<td vAlign="top">
										<table width="100%" align="center" border="0">
											...
											<tr>
												<td><asp:Label ID="lab_processName" runat="server" Text="項目工序名稱"></asp:Label></td>
											...
											<tr>
												<td colSpan="2">
													<asp:datagrid id="dg_ProjectProcessList" runat="server" AutoGenerateColumns="False" CellSpacing="2"
														CellPadding="2">
														...
														<Columns>
															...
															<asp:TemplateColumn HeaderText="processName">
																<HeaderTemplate>
																	<asp:Label id="dg_header_processName" runat="server">項目工序名稱</asp:Label>
																</HeaderTemplate>
																<ItemTemplate>
																	&nbsp;
