<%@ Page language="c#" Codebehind="TypeList.aspx.cs" AutoEventWireup="false" Inherits="ModuleWorkFlow.admin.TypeList" %>
								...
								<tr>
									<td vAlign="top">
										<table width="100%" align="center" border="0">
											...
											<tr>
												<td><asp:Label ID="lab_name" runat="server" Text="單位名稱"></asp:Label></td>
											...
											<tr>
												<td colSpan="2">
													<asp:datagrid id="dg_Type" runat="server" AutoGenerateColumns="False" CellSpacing="2" CellPadding="2">
														...
														<Columns>
															...
															<asp:TemplateColumn HeaderText="name">
																<HeaderTemplate>
																	<asp:Label id="dg_header_name" runat="server">單位名稱</asp:Label>
																</HeaderTemplate>
																<ItemTemplate>
																	&nbsp;
