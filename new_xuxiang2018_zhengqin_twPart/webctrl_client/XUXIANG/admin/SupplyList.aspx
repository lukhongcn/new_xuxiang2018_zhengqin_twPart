								...
								<tr>
									<td vAlign="top">
										<table width="100%" align="center" border="0">
											<tr>
												<td>
													<asp:label ID="lab_search" Runat="server">供應商</asp:label><asp:TextBox ID="txt_search" Runat="server"></asp:TextBox><asp:Button ID="btn_search" Runat="server" Text="查詢"></asp:Button>
													<asp:button ID="btn_print" Runat="server" Text="打印報表"></asp:button>
												</td>
												<td>
													<asp:Label ID="lab_searchold" Runat="server" Visible="False"></asp:Label>
												</td>
											</tr>
											<tr>
												<td colSpan="2">
													<asp:datagrid id="dg_Supply" runat="server" AutoGenerateColumns="False" CellSpacing="2" CellPadding="2"
														...
														<Columns>
															<asp:TemplateColumn HeaderText="supplierId">
																...
																<EditItemTemplate>
																	<asp:textbox id="dg_txt_supplierId" runat="server" Text='<%#DataBinder.Eval(Container, "DataItem.supplierId") %>'/>
																</EditItemTemplate>
															</asp:TemplateColumn>
															<asp:TemplateColumn HeaderText="supplierName">
																...
																<EditItemTemplate>
																	<asp:textbox id="dg_txt_supplierName" runat="server" Text='<%#DataBinder.Eval(Container, "DataItem.supplierName") %>'/>
																</EditItemTemplate>
															</asp:TemplateColumn>
															<asp:TemplateColumn HeaderText="companyTel">
																...
																<EditItemTemplate>
																	<asp:textbox id="dg_txt_companyTel" runat="server" Text='<%#DataBinder.Eval(Container, "DataItem.companyTel") %>'/>
																</EditItemTemplate>
															</asp:TemplateColumn>
															<asp:TemplateColumn HeaderText="responsibility">
																...
																<EditItemTemplate>
																	<asp:textbox id="dg_txt_responsibility" runat="server" Text='<%#DataBinder.Eval(Container, "DataItem.responsibility") %>'/>
																</EditItemTemplate>
															</asp:TemplateColumn>
															<asp:TemplateColumn HeaderText="conatcted">
																...
																<EditItemTemplate>
																	<asp:textbox id="dg_txt_conatcted" runat="server" Text='<%#DataBinder.Eval(Container, "DataItem.conatcted") %>'/>
																</EditItemTemplate>
															</asp:TemplateColumn>
													...
													<asp:datagrid id="dg_Contacter" runat="server" AllowPaging="True" CellPadding="2" CellSpacing="2"
														...
														<Columns>
															<asp:TemplateColumn HeaderText="contactName">
																...
																<EditItemTemplate>
																	<asp:textbox id="dg_txt_contactName" runat="server" Text='<%#DataBinder.Eval(Container, "DataItem.contactName") %>'/>
																</EditItemTemplate>
															</asp:TemplateColumn>
													...
													<asp:datagrid id="Datagrid1" runat="server" AutoGenerateColumns="False" CellSpacing="2" CellPadding="2"
														...
														<Columns>
															<asp:TemplateColumn HeaderText="supplierId">
																<HeaderTemplate>
																	<asp:Label id="Label1" runat="server" text="供應商編號" />
																</HeaderTemplate>
																<ItemTemplate>
																	<asp:Label id="Label2" runat="server" Text='<%#DataBinder.Eval(Container, "DataItem.SupplierId")%>'/>
																</ItemTemplate>
															</asp:TemplateColumn>
															<asp:TemplateColumn HeaderText="supplierName">
																<HeaderTemplate>
																	<asp:Label id="Label3" runat="server" text="供應商名稱" />
																</HeaderTemplate>
																<ItemTemplate>
																	<asp:Label id="Label4" runat="server" Text='<%#DataBinder.Eval(Container, "DataItem.SupplierName")%>'/>
																</ItemTemplate>
															</asp:TemplateColumn>
															<asp:TemplateColumn HeaderText="companyTel">
																<HeaderTemplate>
																	<asp:Label id="Label5" runat="server" text="公司電話" />
																</HeaderTemplate>
																<ItemTemplate>
																	&nbsp;
															...
															<asp:TemplateColumn HeaderText="responsibility">
																<HeaderTemplate>
																	<asp:Label id="Label7" runat="server" text="負責人" />
																</HeaderTemplate>
																<ItemTemplate>
																	&nbsp;
															...
															<asp:TemplateColumn HeaderText="conatcted">
																<HeaderTemplate>
																	<asp:Label id="Label9" runat="server" text="聯絡人" />
																</HeaderTemplate>
																<ItemTemplate>
																	&nbsp;
															...
															<asp:TemplateColumn HeaderText="grender">
																<HeaderTemplate>
																	<asp:Label id="Label11" runat="server" text="性別" />
																</HeaderTemplate>
																<ItemTemplate>
																	&nbsp;
															...
															<asp:TemplateColumn HeaderText="extNo">
																<HeaderTemplate>
																	<asp:Label id="Label13" runat="server" text="分機號碼" />
																</HeaderTemplate>
																<ItemTemplate>
																	&nbsp;
															...
															<asp:TemplateColumn HeaderText="mobile">
																<HeaderTemplate>
																	<asp:Label id="Label15" runat="server" text="手機" />
																</HeaderTemplate>
																<ItemTemplate>
																	&nbsp;
															...
															<asp:TemplateColumn HeaderText="companyFax">
																<HeaderTemplate>
																	<asp:Label id="Label17" runat="server" text="傳真" />
																</HeaderTemplate>
																<ItemTemplate>
																	&nbsp;
															...
															<asp:TemplateColumn HeaderText="email">
																<HeaderTemplate>
																	<asp:Label id="Label19" runat="server" text="E-Mail" />
																</HeaderTemplate>
																<ItemTemplate>
																	&nbsp;
															...
															<asp:TemplateColumn HeaderText="factoryTel">
																<HeaderTemplate>
																	<asp:Label id="Label21" runat="server" text="工廠電話" />
																</HeaderTemplate>
																<ItemTemplate>
																	&nbsp;
