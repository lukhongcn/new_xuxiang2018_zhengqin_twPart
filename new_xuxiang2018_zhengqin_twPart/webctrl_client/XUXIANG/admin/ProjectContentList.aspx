<%@ Page language="c#" Codebehind="ProjectContentList.aspx.cs" AutoEventWireup="false" Inherits="ModuleWorkFlow.ProjectContentList" %>
								...
								<tr>
									<td vAlign="top">
										<table width="100%" align="center" border="0">
											...
											<tr>
												<td><asp:Label ID="lab_content" runat="server" Text="加工內容"></asp:Label></td>
												<td><asp:textbox id="txt_content" runat="server"></asp:textbox></td>
											</tr>
											<tr>
											...
											<tr>
												<td colSpan="2">
													<asp:datagrid id="dg_ProjectContentList" runat="server" AutoGenerateColumns="False" CellSpacing="2"
														CellPadding="2">
														...
														<Columns>
															...
															<asp:TemplateColumn HeaderText="content">
																<HeaderTemplate>
																	<asp:Label id="dg_header_content" runat="server">加工內容</asp:Label>
																</HeaderTemplate>
																<ItemTemplate>
																	&nbsp;
																	<asp:Label id="dg_lab_content" runat="server" Text='<%#DataBinder.Eval(Container, "DataItem.Content")%>'/>
																</ItemTemplate>
																<EditItemTemplate>
																	<asp:textbox id="dg_txt_content" Width="40" runat="server" Text='<%#DataBinder.Eval(Container, "DataItem.content") %>'/>
																</EditItemTemplate>
															</asp:TemplateColumn>
