<%@ Page language="c#" Codebehind="PartTypeView.aspx.cs" AutoEventWireup="false" Inherits="ModuleWorkFlow.PartTypeView" %>
								...
								<tr>
									<td vAlign="top">
										<table width="100%" align="center" border="0">
											...
											<tr>
												<td><asp:label id="lab_Name" runat="server" Text="零件名稱"></asp:label></td>
