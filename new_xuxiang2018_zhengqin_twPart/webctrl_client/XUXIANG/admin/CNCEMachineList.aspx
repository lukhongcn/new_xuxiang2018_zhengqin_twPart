<%@ Page language="c#" Codebehind="CNCEMachineList.aspx.cs" AutoEventWireup="false" Inherits="ModuleWorkFlow.admin.CNCEMachineList" %>
							...
							<asp:datagrid id="MainDataGrid" runat="server" AutoGenerateColumns="False" Width="100%" CellSpacing="2"
								...
								<Columns>
									...
									<asp:TemplateColumn HeaderText="功能">
										<ItemTemplate>
											<asp:HyperLink id=HyperLink_Edit runat="server" Text="編輯" NavigateUrl='<%# "CNCEMachineAddEdit.aspx?func=edit&machineid="+DataBinder.Eval(Container, "DataItem.machineid") %>'>
											</asp:HyperLink>
										</ItemTemplate>
									</asp:TemplateColumn>
