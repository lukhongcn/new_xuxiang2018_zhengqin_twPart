					...
					<TR>
						...
						<TD vAlign="top" width="79%">
							...
							<asp:datagrid id="MainDataGrid" runat="server" AutoGenerateColumns="False" AllowPaging="True"
								...
								<Columns>
									<asp:TemplateColumn HeaderText="客戶編號">
										<ItemTemplate>
											<asp:Label ID=lab_customerid runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.CustomerId") %>' Visible="false">
											</asp:Label>
											<asp:Label ID="lab_customernumber" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.CustomerNumber") %>'>
											</asp:Label>
										</ItemTemplate>
										<EditItemTemplate>
											<asp:Label ID=tx_customerid runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.CustomerId") %>' Visible="false">
											</asp:Label>
											<asp:Label ID="tx_customernumber" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.CustomerNumber") %>'>
											</asp:Label>
										</EditItemTemplate>
									</asp:TemplateColumn>
									<asp:TemplateColumn HeaderText="客戶名稱">
										<ItemTemplate>
									...
									<asp:EditCommandColumn ButtonType="LinkButton" UpdateText="更新" HeaderText="功能" CancelText="取消" EditText="編輯"></asp:EditCommandColumn>
