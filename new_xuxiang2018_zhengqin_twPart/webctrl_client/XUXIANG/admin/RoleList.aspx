					...
					<TR>
						...
						<TD vAlign="top" width="79%"><uc1:roleheader id="RoleHeader" runat="server"></uc1:roleheader><BR>
							<asp:datagrid id="MainDataGrid" runat="server" AutoGenerateColumns="False" Width="100%" CellSpacing="2"
								...
								<Columns>
									<asp:BoundColumn DataField="RoleId" HeaderText="角色編號"></asp:BoundColumn>
									<asp:BoundColumn DataField="RoleName" HeaderText="角色名稱"></asp:BoundColumn>
									<asp:TemplateColumn HeaderText="功能">
										<ItemTemplate>
											<asp:HyperLink id=HyperLink_Edit runat="server" Text="編輯" NavigateUrl='<%# "RoleAddEdit.aspx?func=edit&roleid="+DataBinder.Eval(Container, "DataItem.roleid") %>'>
											</asp:HyperLink>
										</ItemTemplate>
									</asp:TemplateColumn>
