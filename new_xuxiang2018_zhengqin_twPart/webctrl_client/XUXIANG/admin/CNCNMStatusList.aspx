					...
					<TR>
						...
						<TD vAlign="top" width="79%">
							...
							<asp:datagrid id="MainDataGrid" runat="server" AutoGenerateColumns="False" Width="100%" CellSpacing="2"
								...
								<Columns>
									<asp:BoundColumn DataField="CNCNID" HeaderText="機台編號"></asp:BoundColumn>
									...
									<asp:TemplateColumn HeaderText="功能">
										<ItemTemplate>
											<asp:HyperLink id=HyperLink_Edit runat="server" Text="編輯" NavigateUrl='<%# "CNCNMStatusAddEdit.aspx?func=edit&machineid="+DataBinder.Eval(Container, "DataItem.cncnid")+"&partno="+DataBinder.Eval(Container, "DataItem.partno")+"&partno_id="+DataBinder.Eval(Container, "DataItem.partno_id")+"&moduleid="+DataBinder.Eval(Container, "DataItem.moduleid")+"&processdate="+string.Format("{0:yyyy-MM-dd}",DataBinder.Eval(Container, "DataItem.processdate"))%>'>
											</asp:HyperLink>
										</ItemTemplate>
									</asp:TemplateColumn>
