								...
								<tr>
									<td vAlign="top">
										<table width="100%" align="center" border="0">
											...
											<tr>
												<td><asp:label id="lab_myNo" runat="server" Text="編號"></asp:label></td>
												...
												<td><asp:label id="lab_inOutInventoryTypeId" runat="server" Text="出庫類型"></asp:label></td>
												<td><asp:dropdownlist id="dpl_inOutInventoryTypeId" runat="server"></asp:dropdownlist></td>
											</tr>
											<tr>
												...
												<TR>
													<TD>
														<TABLE id="Table3" width="100%" align="center" border="0" >
															...
															<TR>
																<TD>
																	<asp:label id="lab_outPCS" runat="server" Text="出庫批號"></asp:label>
																</TD>
																<TD>
																	<asp:textbox id="txt_outPCS" runat="server"></asp:textbox>
																</TD>
																...
																<TD>
																	<asp:label id="lab_unitId" runat="server" Text="單位"></asp:label>
																</TD>
																<TD>
																	<asp:dropdownlist id="dpl_unitId" runat="server"></asp:dropdownlist>
																</TD>
															</TR>
															<TR>
																<TD>
															...
															<TR>
																<TD colSpan="2">
																	<asp:datagrid id="dg_OutInventoryDetail" runat="server" CellPadding="2" CellSpacing="2" AutoGenerateColumns="False"
																		AllowPaging="True">
