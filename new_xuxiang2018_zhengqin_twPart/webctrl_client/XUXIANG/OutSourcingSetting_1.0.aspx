				...
				<TBODY>
					...
					<TR>
						...
						<TD vAlign="top" width="79%">
							<uc1:OutSourcingHeader id="OutSourcingHeader" runat="server"></uc1:OutSourcingHeader><FONT face="冼極"><BR>
							</FONT>
							<BR>
									...
									<TR>
										<td colSpan="2">
											<TABLE id="Table4" cellSpacing="0" cellPadding="0" width="100%" border="1">
												<tr>
													<TD>客戶名稱<asp:dropdownlist id="ListBox_CustomerList" runat="server" AutoPostBack="True"></asp:dropdownlist></TD>
													...
													<TD><asp:Button id="Button_Search" runat="server" Text="查詢"></asp:Button></TD>
												</tr>
											</TABLE>
										</td>
									</TR>
